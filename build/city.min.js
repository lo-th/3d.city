...
Micro.BlockMap.prototype={constructor:Micro.BlockMap,clear:function(){for(var a=Math.floor(this.mapWidth/this.blockSize)+1,b=Math.floor(this.mapHeight/this.blockSize)+1;b--;)this.data[b]=Micro.makeArrayOf(a,this.defaultValue)},get:function(a,b){return this.data[b][a]},set:function(a,b,c){this.data[b][a]=c},toBlock:function(a){return Math.floor(a/this.blockSize)},worldGet:function(a,b){return this.get(this.toBlock(a),this.toBlock(b))},worldSet:function(a,b,c){this.set(this.toBlock(a),this.toBlock(b),
c)}};var Residential,Commercial,Industrial,Transport,Road,EmergencyServices,MiscTiles,Stadia;
Micro.Simulation=function(a,b,c,d){if(b!==Micro.LEVEL_EASY&&b!==Micro.LEVEL_MED&&b!==Micro.LEVEL_HARD)throw Error("Invalid level!");if(c!==Micro.SPEED_PAUSED&&c!==Micro.SPEED_SLOW&&c!==Micro.SPEED_MED&&c!==Micro.SPEED_FAST)throw Error("Invalid speed!");this.map=a;this.gameLevel=b;this.div=this.map.width/8;this.is3D=d||!1;this.needPower=[];this.speed=c;this.simCycle=this.phaseCycle=this.speedCycle=0;this.doInitialEval=!0;this.cityTime=50;this.cityPopLast=0;this.messageLast=Messages.VILLAGE_REACHED;
this.startingYear=1900;this.indValveLast=this.comValveLast=this.resValveLast=0;this._cityMonthLast=this._cityYearLast=-1;this.evaluation=new Micro.Evaluation(this.gameLevel,this);this.valves=new Micro.Valves;this.budget=new Micro.Budget;this.census=new Micro.Census;this.messageManager=new Micro.MessageManager;this.powerManager=new Micro.PowerManager(this.map,this);this.spriteManager=new Micro.SpriteManager(this.map,this);this.mapScanner=new Micro.MapScanner(this.map,this);this.repairManager=new Micro.RepairManager(this.map);
