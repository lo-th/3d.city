...
a.simulation.spriteManager.moveObjects());var d=new Date;a.sprite=a.calculateSpritesForPaint();var e=new Date;a.gameCanvas.paint(a.mouse,a.sprite,a.isPaused);var f=new Date;a.debug.innerHTML="input:"+(c-b)+" sim:"+(d-c)+" sprite:"+(e-d)+" paint:"+(f-e)+"<br> total:"+(f-b)+"<br>"+a.isPaused}};
