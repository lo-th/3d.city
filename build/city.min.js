...
Micro.MouseBox={draw:function(a,b,c,d,e){var f=e.lineWidth||3,g=e.colour||"yellow",h=-1,k=1;"outline"in e&&!0===e.outline||(h=1,k=-1);e=b.x+h*f*0.5;c+=k*f;b=b.y+h*f*0.5;d+=k*f;a=a.getContext("2d");a.lineWidth=f;a.strokeStyle=g;a.strokeRect(e,b,c,d)}};Micro.clamp=function(a,b,c){return a<b?b:a>c?c:a};Micro.makeConstantDescriptor=function(a){return{configurable:!1,enumerable:!1,writeable:!1,value:a}};
Micro.rotate10Arrays=function(){for(var a=0;a<Micro.arrs.length;a++){var b=Micro.arrs[a]+"Hist10";this[b]=[0].concat(this[b].slice(0,-1))}};Micro.rotate120Arrays=function(){for(var a=0;a<Micro.arrs.length;a++){var b=Micro.arrs[a]+"Hist120";this[b]=[0].concat(this[b].slice(0,-1))}};Micro.isCallable=function(a){return"function"===typeof a};Micro.LEVEL_EASY=0;Micro.LEVEL_MED=1;Micro.LEVEL_HARD=2;Micro.SPEED_PAUSED=0;Micro.SPEED_SLOW=1;Micro.SPEED_MED=2;Micro.SPEED_FAST=3;Micro.ROUTE_FOUND=1;
Micro.NO_ROUTE_FOUND=0;Micro.NO_ROAD_FOUND=-1;Micro.MAX_TRAFFIC_DISTANCE=30;Micro.perimX=[-1,0,1,2,2,2,1,0,-1,-2,-2,-2];Micro.perimY=[-2,-2,-2,-1,0,1,2,2,2,1,0,-1];Micro.SPRITE_TRAIN=1;Micro.SPRITE_HELICOPTER=2;Micro.SPRITE_AIRPLANE=3;Micro.SPRITE_SHIP=4;Micro.SPRITE_MONSTER=5;Micro.SPRITE_TORNADO=6;Micro.SPRITE_EXPLOSION=7;Micro.CC_VILLAGE="VILLAGE";Micro.CC_TOWN="TOWN";Micro.CC_CITY="CITY";Micro.CC_CAPITAL="CAPITAL";Micro.CC_METROPOLIS="METROPOLIS";Micro.CC_MEGALOPOLIS="MEGALOPOLIS";
Micro.CRIME=0;Micro.POLLUTION=1;Micro.HOUSING=2;Micro.TAXES=3;Micro.TRAFFIC=4;Micro.UNEMPLOYMENT=5;Micro.FIRE=6;Micro.RES_VALVE_RANGE=2E3;Micro.COM_VALVE_RANGE=1500;Micro.IND_VALVE_RANGE=1500;Micro.taxTable=[200,150,120,100,80,50,30,0,-10,-40,-100,-150,-200,-250,-300,-350,-400,-450,-500,-550,-600];Micro.extMarketParamTable=[1.2,1.1,0.98];Micro.RLevels=[0.7,0.9,1.2];Micro.FLevels=[1.4,1.2,0.8];Micro.MAX_ROAD_EFFECT=32;Micro.MAX_POLICESTATION_EFFECT=1E3;Micro.MAX_FIRESTATION_EFFECT=1E3;
Micro.COAL_POWER_STRENGTH=700;Micro.NUCLEAR_POWER_STRENGTH=2E3;Micro.DISASTER_NONE="None";Micro.DISASTER_MONSTER="Monster";Micro.DISASTER_FIRE="Fire";Micro.DISASTER_FLOOD="Flood";Micro.DISASTER_CRASH="Crash";Micro.DISASTER_MELTDOWN="Meltdown";Micro.DISASTER_TORNADO="Tornado";Micro.Random=function(){};Micro.Random.prototype={constructor:Micro.Random,getChance:function(a){return 0===(this.getRandom16()&a)},getERandom:function(a){var b=this.getRandom(a);a=this.getRandom(a);return Math.min(b,a)},getRandom:function(a){return Math.floor(Math.random()*(a+1))},getRandom16:function(){return this.getRandom(65535)},getRandom16Signed:function(){var a=this.getRandom16();32768<=a&&(a=32768-a);return a}};var Random=new Micro.Random;Micro.Direction=function(){};
...
var TXT=new Micro.Text;Micro.Census=function(){this.clearCensus();this.changed=!1;this.totalPop=this.crimeAverage=this.pollutionAverage=this.landValueAverage=this.pollutionRamp=this.crimeRamp=0;for(var a=function(a){this[a]=[];for(var b=0;120>b;b++)this[a][b]=0},b=0;b<Micro.arrs.length;b++){var c=Micro.arrs[b]+"Hist120";a.call(this,Micro.arrs[b]+"Hist10");a.call(this,c)}};
Micro.Census.prototype={constructor:Micro.Census,clearCensus:function(){this.airportPop=this.seaportPop=this.nuclearPowerPop=this.coalPowerPop=this.stadiumPop=this.fireStationPop=this.policeStationPop=this.churchPop=this.hospitalPop=this.indZonePop=this.comZonePop=this.resZonePop=this.indPop=this.comPop=this.resPop=this.railTotal=this.roadTotal=this.firePop=this.unpoweredZoneCount=this.poweredZoneCount=0},take10Census:function(a){Micro.rotate10Arrays.call(this);this.resHist10[0]=Math.floor(this.resPop/
8);this.comHist10[0]=this.comPop;this.indHist10[0]=this.indPop;this.crimeRamp+=Math.floor((this.crimeAverage-this.crimeRamp)/4);this.crimeHist10[0]=Math.min(this.crimeRamp,255);this.pollutionRamp+=Math.floor((this.pollutionAverage-this.pollutionRamp)/4);this.pollutionHist10[0]=Math.min(this.pollutionRamp,255);this.moneyHist10[0]=Micro.clamp(Math.floor(a.cashFlow/20)+128,0,255);this.hospitalPop<this.resPopScaled?this.needHospital=1:this.hospitalPop>this.resPopScaled?this.needHospital=-1:this.hospitalPop===
this.resPopScaled&&(this.needHospital=0);this.changed=!0},take120Census:function(){Micro.rotate120Arrays.call(this);this.resHist120[0]=Math.floor(this.resPop/8);this.comHist120[0]=this.comPop;this.indHist120[0]=this.indPop;this.crimeHist120[0]=this.crimeHist10[0];this.pollutionHist120[0]=this.pollutionHist10[0];this.moneyHist120[0]=this.moneyHist10[0];this.changed=!0}};Micro.PROBLEMS="CVP_CRIME CVP_POLLUTION CVP_HOUSING CVP_TAXES CVP_TRAFFIC CVP_UNEMPLOYMENT CVP_FIRE".split(" ");Micro.NUMPROBLEMS=Micro.PROBLEMS.length;Micro.NUM_COMPLAINTS=4;Micro.getTrafficAverage=function(a){var b=a.trafficDensityMap;a=a.landValueMap;for(var c=0,d=1,e=0;e<a.mapWidth;e+=a.blockSize)for(var f=0;f<a.mapHeight;f+=a.blockSize)0<a.worldGet(e,f)&&(c+=b.worldGet(e,f),d++);return 2.4*Math.floor(c/d)};
...
Micro.Evaluation.prototype={constructor:Micro.Evaluation,cityEvaluation:function(){var a=this.sim.census;if(0<a.totalPop){for(var b=[],c=0;c<Micro.NUMPROBLEMS;c++)b.push(0);this.getAssessedValue(a);this.doPopNum(a);this.doProblems(this.sim.census,this.sim.budget,this.sim.blockMaps,b);this.getScore(b);this.doVotes()}else this.evalInit(),this.cityYes=50;this.changeEval()},evalInit:function(){this.cityAssessedValue=this.cityPopDelta=this.cityPop=this.cityYes=0;this.cityClass=Micro.CC_VILLAGE;this.cityScore=
500;for(var a=this.cityScoreDelta=0;a<Micro.NUMPROBLEMS;a++)this.problemVotes[a]=0;for(a=0;a<Micro.NUM_COMPLAINTS;a++)this.problemOrder[a]=Micro.NUMPROBLEMS},getAssessedValue:function(a){var b;b=5*a.roadTotal;b+=10*a.railTotal;b+=1E3*a.policeStationPop;b+=1E3*a.fireStationPop;b+=400*a.hospitalPop;b+=3E3*a.stadiumPop;b+=5E3*a.seaportPop;b+=1E4*a.airportPop;b+=3E3*a.coalPowerPop;b+=6E3*a.nuclearPowerPop;this.cityAssessedValue=1E3*b},getPopulation:function(a){return 20*(a.resPop+8*(a.comPop+a.indPop))},
doPopNum:function(a){var b=this.cityPop;this.cityPop=this.getPopulation(a);-1==b&&(b=this.cityPop);this.cityPopDelta=this.cityPop-b;this.cityClass=this.getCityClass(this.cityPop)},getCityClass:function(a){this.cityClassification=Micro.CC_VILLAGE;2E3<a&&(this.cityClassification=Micro.CC_TOWN);1E4<this.cityPopulation&&(this.cityClassification=Micro.CC_CITY);5E4<this.cityPopulation&&(this.cityClassification=Micro.CC_CAPITAL);1E5<this.cityPopulation&&(this.cityClassification=Micro.CC_METROPOLIS);5E5<
this.cityPopulation&&(this.cityClassification=Micro.CC_MEGALOPOLIS);return this.cityClassification},voteProblems:function(a){for(var b=0;b<Micro.NUMPROBLEMS;b++)this.problemVotes[b]=0;for(var c=b=0,d=0;100>c&&600>d;)Random.getRandom(300)<a[b]&&(this.problemVotes[b]++,c++),b++,b>Micro.NUMPROBLEMS&&(b=0),d++},doProblems:function(a,b,c,d){for(var e=[],f=0;f<Micro.NUMPROBLEMS;f++)e[f]=!1,d[f]=0;d[Micro.CRIME]=a.crimeAverage;d[Micro.POLLUTION]=a.pollutionAverage;d[Micro.HOUSING]=7*a.landValueAverage/10;
d[Micro.TAXES]=10*b.cityTax;d[Micro.TRAFFIC]=Micro.getTrafficAverage(c);d[Micro.UNEMPLOYMENT]=Micro.getUnemployment(a);d[Micro.FIRE]=Micro.getFireSeverity(a);this.voteProblems(d);for(f=0;f<Micro.NUM_COMPLAINTS;f++){a=0;b=Micro.NUMPROBLEMS;for(c=0;c<Micro.NUMPROBLEMS;c++)this.problemVotes[c]>a&&!e[c]&&(b=c,a=this.problemVotes[c]);this.problemOrder[f]=b;b<Micro.NUMPROBLEMS&&(e[b]=!0)}},getScore:function(a){var b=this.sim.census,c=this.sim.budget,d=this.sim.valves,e;e=this.cityScore;for(var f=0,g=0;g<
Micro.NUMPROBLEMS;g++)f+=a[g];f=Math.floor(f/3);f=Math.min(f,256);f=Micro.clamp(4*(256-f),0,1E3);d.resCap&&(f=Math.round(0.85*f));d.comCap&&(f=Math.round(0.85*f));d.indCap&&(f=Math.round(0.85*f));c.roadEffect<c.MAX_ROAD_EFFECT&&(f-=c.MAX_ROAD_EFFECT-c.roadEffect);c.policeEffect<c.MAX_POLICE_STATION_EFFECT&&(f=Math.round(f*(0.9+c.policeEffect/(10.0001*c.MAX_POLICE_STATION_EFFECT))));c.fireEffect<c.MAX_FIRE_STATION_EFFECT&&(f=Math.round(f*(0.9+c.fireEffect/(10.0001*c.MAX_FIRE_STATION_EFFECT))));-1E3>
d.resValve&&(f=Math.round(0.85*f));-1E3>d.comValve&&(f=Math.round(0.85*f));-1E3>d.indValve&&(f=Math.round(0.85*f));a=1;0===this.cityPop||0===this.cityPopDelta?a=1:this.cityPopDelta==this.cityPop?a=1:0<this.cityPopDelta?a=this.cityPopDelta/this.cityPop+1:0>this.cityPopDelta&&(a=0.95+Math.floor(this.cityPopDelta/(this.cityPop-this.cityPopDelta)));f=Math.round(f*a);f=f-Micro.getFireSeverity(b)-c.cityTax;a=b.unpoweredZoneCount+b.poweredZoneCount;0<a&&(f=Math.round(b.poweredZoneCount/a*f));f=Micro.clamp(f,
0,1E3);this.cityScore=Math.round((this.cityScore+f)/2);this.cityScoreDelta=this.cityScore-e},doVotes:function(){var a;for(a=this.cityYes=0;100>a;a++)Random.getRandom(1E3)<this.cityScore&&this.cityYes++},changeEval:function(){this.changed=!0},countProblems:function(){var a;for(a=0;a<Micro.NUM_COMPLAINTS&&this.problemOrder[a]!==Micro.NUMPROBLEMS;a++);return a},getProblemNumber:function(a){return 0>a||a>=Micro.NUM_COMPLAINTS||this.problemOrder[a]===Micro.NUMPROBLEMS?-1:this.problemOrder[a]},getProblemVotes:function(a){return 0>
a||a>=Micro.NUM_COMPLAINTS||this.problemOrder[a]==Micro.NUMPROBLEMS?-1:this.problemVotes[this.problemOrder[a]]}};Micro.Budget=function(){this.roadEffect=Micro.MAX_ROAD_EFFECT;this.policeEffect=Micro.MAX_POLICESTATION_EFFECT;this.fireEffect=Micro.MAX_FIRESTATION_EFFECT;this.totalFunds=0;this.cityTax=7;this.policeFund=this.fireFund=this.roadFund=this.taxFund=this.cashFlow=0;this.policePercent=this.firePercent=this.roadPercent=1;this.policeSpend=this.fireSpend=this.roadSpend=0;this.autoBudget=!0};
Micro.Budget.prototype={constructor:Micro.Budget,doBudget:function(a){return this.doBudgetNow(!1,a)},doBudgetMenu:function(a){return this.doBudgetNow(!1,a)},doBudgetNow:function(a,b){this.roadSpend=Math.round(this.roadFund*this.roadPercent);this.fireSpend=Math.round(this.fireFund*this.firePercent);this.policeSpend=Math.round(this.policeFund*this.policePercent);var c=this.roadSpend+this.fireSpend+this.policeSpend;0===c&&(this.policePercent=this.firePercent=this.roadPercent=1,this.roadEffect=this.MAX_ROAD_EFFECT,
this.policeEffect=this.MAX_POLICESTATION_EFFECT,this.fireEffect=this.MAX_FIRESTATION_EFFECT);var d=this.totalFunds+this.taxFund,e=d,f=0,g=0,h=0,f=e>=this.roadSpend?this.roadSpend:e,e=e-f,g=e>=this.fireSpend?this.fireSpend:e,e=e-g,h=e>=this.policeSpend?this.policeSpend:e;this.roadPercent=0<this.roadFund?(new Number(f/this.roadFund)).toPrecision(2)-0:1;0<this.fireFund?this.firePercent=(new Number(g/this.fireFund)).toPrecision(2)-0:this.fireFund=1;0<this.policeFund?this.policePercent=(new Number(h/this.policeFund)).toPrecision(2)-
0:this.policeFund=1;!this.autoBudget||a?a||this.doBudgetSpend(f,g,h,this.cityTax,b):d>=c?this.doBudgetSpend(f,g,h,this.cityTax,b):(this.autoBudget=!1,b.sendMessage(Messages.AUTOBUDGET_CHANGED,this.autoBudget),b.sendMessage(Messages.BUDGET_NEEDED),b.sendMessage(Messages.NO_MONEY))},doBudgetSpend:function(a,b,c,d,e){this.roadSpend=a;this.fireSpend=b;this.policeSpend=c;this.setTax(d);this.spend(-(this.taxFund-(this.roadSpend+this.fireSpend+this.policeSpend)),e);this.updateFundEffects()},updateFundEffects:function(){this.roadEffect=
Micro.MAX_ROAD_EFFECT;this.policeEffect=Micro.MAX_POLICESTATION_EFFECT;this.fireEffect=Micro.MAX_FIRESTATION_EFFECT;0<this.roadFund&&(this.roadEffect=Math.floor(this.roadEffect*this.roadSpend/this.roadFund));0<this.fireFund&&(this.fireEffect=Math.floor(this.fireEffect*this.fireSpend/this.fireFund));0<this.policeFund&&(this.policeEffect=Math.floor(this.policeEffect*this.policeSpend/this.policeFund))},collectTax:function(a,b,c){this.cashFlow=0;this.policeFund=100*b.policeStationPop;this.fireFund=100*
b.fireStationPop;this.roadFund=Math.floor((b.roadTotal+2*b.railTotal)*Micro.RLevels[a]);this.taxFund=Math.floor(Math.floor(b.totalPop*b.landValueAverage/120)*this.cityTax*Micro.FLevels[a]);0<b.totalPop?(this.cashFlow=this.taxFund-(this.policeFund+this.fireFund+this.roadFund),this.doBudget(c)):(this.roadEffect=Micro.MAX_ROAD_EFFECT,this.policeEffect=Micro.MAX_POLICESTATION_EFFECT,this.fireEffect=Micro.MAX_FIRESTATION_EFFECT)},setTax:function(a,b){a!==this.cityTax&&(this.cityTax=a,void 0!==b&&b.sendMessage(Messages.TAXRATE_CHANGED,
this.cityTax))},setFunds:function(a,b){a!==this.totalFunds&&(this.totalFunds=Math.max(0,a),void 0!==b&&b.sendMessage(Messages.FUNDS_CHANGED,this.totalFunds))},spend:function(a,b){this.setFunds(this.totalFunds-a,b)},shouldDegradeRoad:function(){return this.roadEffect<Math.floor(15*this.MAX_ROAD_EFFECT/16)}};Micro.Valves=function(){this.changed=!1;this.indValve=this.comValve=this.resValve=0;this.indCap=this.comCap=this.resCap=!1};
Micro.Valves.prototype={constructor:Micro.Valves,setValves:function(a,b,c){var d,e=b.resPop/8;b.totalPop=Math.round(e+b.comPop+b.indPop);var f=e+e*((0<b.resPop?(b.comHist10[1]+b.indHist10[1])/e:1)-1)+0.02*e,g=b.comHist10[1]+b.indHist10[1];d=0<g?b.resHist10[1]/g:1;d=Micro.clamp(d,0,1.3);g=(e+b.comPop+b.indPop)/3.7*d;d=b.indPop*d*Micro.extMarketParamTable[a];d=Math.max(d,5);g=0<b.comPop?g/b.comPop:g;b=0<b.indPop?d/b.indPop:d;Math.min(0<e?f/e:1.3,2);g=Math.min(g,2);e=Math.min(b,2);a=Math.min(c.cityTax+
a,20);e=600*(e-1)+Micro.taxTable[a];g=600*(g-1)+Micro.taxTable[a];b=600*(b-1)+Micro.taxTable[a];this.resValve=Micro.clamp(this.resValve+Math.round(e),-Micro.RES_VALVE_RANGE,Micro.RES_VALVE_RANGE);this.comValve=Micro.clamp(this.comValve+Math.round(g),-Micro.COM_VALVE_RANGE,Micro.COM_VALVE_RANGE);this.indValve=Micro.clamp(this.indValve+Math.round(b),-Micro.IND_VALVE_RANGE,Micro.IND_VALVE_RANGE);this.resCap&&0<this.resValve&&(this.resValve=0);this.comCap&&0<this.comValve&&(this.comValve=0);this.indCap&&
0<this.indValve&&(this.indValve=0);this.changed=!0}};Micro.Tile=function(a,b){if(!(this instanceof Micro.Tile))return new Micro.Tile;if(arguments.length&&("number"!==typeof a||1<arguments.length&&"number"!==typeof b||0>a))throw Error("Invalid parameter");if(1<arguments.length&&(a>=Tile.TILE_COUNT||b<Tile.BIT_START||b>=Tile.BIT_END<<1))throw Error("Invalid parameter");this._value=a;void 0===this._value&&(this._value=Tile.DIRT);1<arguments.length&&(this._value|=b)};
Micro.Tile.prototype={constructor:Micro.Tile,getValue:function(){return this._value&Tile.BIT_MASK},setValue:function(a){if(!arguments.length||"number"!==typeof a||0>a)throw Error("Invalid parameter");var b=0;a<Tile.BIT_START&&(b=this.getFlags());this._value=a|b},isBulldozable:function(){return 0<(this._value&Tile.BULLBIT)},isAnimated:function(){return 0<(this._value&Tile.ANIMBIT)},isConductive:function(){return 0<(this._value&Tile.CONDBIT)},isCombustible:function(){return 0<(this._value&Tile.BURNBIT)},
isPowered:function(){return 0<(this._value&Tile.POWERBIT)},isZone:function(){return 0<(this._value&Tile.ZONEBIT)},addFlags:function(a){if(!arguments.length||"number"!==typeof a||a<Tile.BIT_START||a>=Tile.BIT_END<<1)throw Error("Invalid parameter");this._value|=a},removeFlags:function(a){if(!arguments.length||"number"!==typeof a||a<Tile.BIT_START||a>=Tile.BIT_END<<1)throw Error("Invalid parameter");this._value&=~a},setFlags:function(a){if("number"!==typeof a||a<Tile.BIT_START||a>=Tile.BIT_END<<1)throw Error("Invalid parameter");
this._value=this._value&~Tile.ALLBITS|a},getFlags:function(){return this._value&Tile.ALLBITS},getRawValue:function(){return this._value},set:function(a,b){if(2>arguments.length||"number"!==typeof a||"number"!==typeof b||a>=Tile.TILE_COUNT)throw Error("Invalid parameter");this.setValue(a);this.setFlags(b)},toString:function(){var a="Tile# "+this.getValue(),a=a+(this.isCombustible()?" burning":""),a=a+(this.isPowered()?" powered":""),a=a+(this.isAnimated()?" animated":""),a=a+(this.isConductive()?" conductive":
""),a=a+(this.isZone()?" zone":"");return a+=this.isBulldozable()?" bulldozeable":""}};var Tile={POWERBIT:32768,CONDBIT:16384,BURNBIT:8192,BULLBIT:4096,ANIMBIT:2048,ZONEBIT:1024};Tile.BLBNBIT=Tile.BULLBIT|Tile.BURNBIT;Tile.BLBNCNBIT=Tile.BULLBIT|Tile.BURNBIT|Tile.CONDBIT;Tile.BNCNBIT=Tile.BURNBIT|Tile.CONDBIT;Tile.ASCBIT=Tile.ANIMBIT|Tile.CONDBIT|Tile.BURNBIT;Tile.ALLBITS=Tile.POWERBIT|Tile.CONDBIT|Tile.BURNBIT|Tile.BULLBIT|Tile.ANIMBIT|Tile.ZONEBIT;Tile.BIT_START=1024;Tile.BIT_END=32768;
Tile.BIT_MASK=Tile.BIT_START-1;Tile.DIRT=0;Tile.RIVER=2;Tile.REDGE=3;Tile.CHANNEL=4;Tile.FIRSTRIVEDGE=5;Tile.LASTRIVEDGE=20;Tile.WATER_LOW=Tile.RIVER;Tile.WATER_HIGH=Tile.LASTRIVEDGE;Tile.TREEBASE=21;Tile.WOODS_LOW=Tile.TREEBASE;Tile.LASTTREE=36;Tile.WOODS=37;Tile.UNUSED_TRASH1=38;Tile.UNUSED_TRASH2=39;Tile.WOODS_HIGH=Tile.UNUSED_TRASH2;Tile.WOODS2=40;Tile.WOODS3=41;Tile.WOODS4=42;Tile.WOODS5=43;Tile.RUBBLE=44;Tile.LASTRUBBLE=47;Tile.FLOOD=48;Tile.LASTFLOOD=51;Tile.RADTILE=52;Tile.UNUSED_TRASH3=53;
Tile.UNUSED_TRASH4=54;Tile.UNUSED_TRASH5=55;Tile.FIRE=56;Tile.FIREBASE=Tile.FIRE;Tile.LASTFIRE=63;Tile.HBRIDGE=64;Tile.ROADBASE=Tile.HBRIDGE;Tile.VBRIDGE=65;Tile.ROADS=66;Tile.ROADS2=67;Tile.ROADS3=68;Tile.ROADS4=69;Tile.ROADS5=70;Tile.ROADS6=71;Tile.ROADS7=72;Tile.ROADS8=73;Tile.ROADS9=74;Tile.ROADS10=75;Tile.INTERSECTION=76;Tile.HROADPOWER=77;Tile.VROADPOWER=78;Tile.BRWH=79;Tile.LTRFBASE=80;Tile.BRWV=95;Tile.BRWXXX1=111;Tile.BRWXXX2=127;Tile.BRWXXX3=143;Tile.HTRFBASE=144;Tile.BRWXXX4=159;
Tile.BRWXXX5=175;Tile.BRWXXX6=191;Tile.LASTROAD=206;Tile.BRWXXX7=207;Tile.HPOWER=208;Tile.VPOWER=209;Tile.LHPOWER=210;Tile.LVPOWER=211;Tile.LVPOWER2=212;Tile.LVPOWER3=213;Tile.LVPOWER4=214;Tile.LVPOWER5=215;Tile.LVPOWER6=216;Tile.LVPOWER7=217;Tile.LVPOWER8=218;Tile.LVPOWER9=219;Tile.LVPOWER10=220;Tile.RAILHPOWERV=221;Tile.RAILVPOWERH=222;Tile.POWERBASE=Tile.HPOWER;Tile.LASTPOWER=Tile.RAILVPOWERH;Tile.UNUSED_TRASH6=223;Tile.HRAIL=224;Tile.VRAIL=225;Tile.LHRAIL=226;Tile.LVRAIL=227;Tile.LVRAIL2=228;
Tile.LVRAIL3=229;Tile.LVRAIL4=230;Tile.LVRAIL5=231;Tile.LVRAIL6=232;Tile.LVRAIL7=233;Tile.LVRAIL8=234;Tile.LVRAIL9=235;Tile.LVRAIL10=236;Tile.HRAILROAD=237;Tile.VRAILROAD=238;Tile.RAILBASE=Tile.HRAIL;Tile.LASTRAIL=238;Tile.ROADVPOWERH=239;Tile.RESBASE=240;Tile.FREEZ=244;Tile.HOUSE=249;Tile.LHTHR=Tile.HOUSE;Tile.HHTHR=260;Tile.RZB=265;Tile.HOSPITALBASE=405;Tile.HOSPITAL=409;Tile.CHURCHBASE=414;Tile.CHURCH0BASE=414;Tile.CHURCH=418;Tile.CHURCH0=418;Tile.COMBASE=423;Tile.COMCLR=427;Tile.CZB=436;
Tile.COMLAST=609;Tile.INDBASE=612;Tile.INDCLR=616;Tile.LASTIND=620;Tile.IND1=621;Tile.IZB=625;Tile.IND2=641;Tile.IND3=644;Tile.IND4=649;Tile.IND5=650;Tile.IND6=676;Tile.IND7=677;Tile.IND8=686;Tile.IND9=689;Tile.PORTBASE=693;Tile.PORT=698;Tile.LASTPORT=708;Tile.AIRPORTBASE=709;Tile.RADAR=711;Tile.AIRPORT=716;Tile.COALBASE=745;Tile.POWERPLANT=750;Tile.LASTPOWERPLANT=760;Tile.FIRESTBASE=761;Tile.FIRESTATION=765;Tile.POLICESTBASE=770;Tile.POLICESTATION=774;Tile.STADIUMBASE=779;Tile.STADIUM=784;
Tile.FULLSTADIUM=800;Tile.NUCLEARBASE=811;Tile.NUCLEAR=816;Tile.LASTZONE=826;Tile.LIGHTNINGBOLT=827;Tile.HBRDG0=828;Tile.HBRDG1=829;Tile.HBRDG2=830;Tile.HBRDG3=831;Tile.HBRDG_END=832;Tile.RADAR0=832;Tile.RADAR1=833;Tile.RADAR2=834;Tile.RADAR3=835;Tile.RADAR4=836;Tile.RADAR5=837;Tile.RADAR6=838;Tile.RADAR7=839;Tile.FOUNTAIN=840;Tile.INDBASE2=844;Tile.TELEBASE=844;Tile.TELELAST=851;Tile.SMOKEBASE=852;Tile.TINYEXP=860;Tile.SOMETINYEXP=864;Tile.LASTTINYEXP=867;Tile.TINYEXPLAST=883;Tile.COALSMOKE1=916;
Tile.COALSMOKE2=920;Tile.COALSMOKE3=924;Tile.COALSMOKE4=928;Tile.FOOTBALLGAME1=932;Tile.FOOTBALLGAME2=940;Tile.VBRDG0=948;Tile.VBRDG1=949;Tile.VBRDG2=950;Tile.VBRDG3=951;Tile.NUKESWIRL1=952;Tile.NUKESWIRL2=953;Tile.NUKESWIRL3=954;Tile.NUKESWIRL4=955;Tile.CHURCH1BASE=956;Tile.CHURCH1=960;Tile.CHURCH2BASE=965;Tile.CHURCH2=969;Tile.CHURCH3BASE=974;Tile.CHURCH3=978;Tile.CHURCH4BASE=983;Tile.CHURCH4=987;Tile.CHURCH5BASE=992;Tile.CHURCH5=996;Tile.CHURCH6BASE=1001;Tile.CHURCH6=1005;Tile.CHURCH7BASE=1010;
Tile.CHURCH7=1014;Tile.CHURCH7LAST=1018;Tile.TILE_COUNT=1024;Tile.TILE_INVALID=-1;Tile.MIN_SIZE=16;Micro.TileSet=function(a,b,c){this.loaded=!1;this._successCallback=b;this._errorCallback=c;var d=this;if(a instanceof Image)setTimeout(function(){d._verifyImage(a)},0);else{var e=new Image;e.onload=function(){d._verifyImage(e)};e.onerror=function(){d._triggerCallback(!1)};e.src=a}};
Micro.TileSet.prototype={constructor:Micro.TileSet,load:function(a,b,c){if(this.loaded)throw Error("TileSet already loaded");this._successCallback=b;this._errorCallback=c;if(a instanceof Image)this._verifyImage(a);else{var d=new Image,e=this;d.onload=function(){e._verifyImage(d)};d.onerror=function(){e._triggerCallback(!1)};d.src=a}},_triggerCallback:function(a){if(this._successCallback){var b=this._successCallback;a||(b=this._errorCallback);delete this._successCallback;delete this._errorCallback;
b()}},_verifyImage:function(a){var b=a.width,c=a.height,d=Math.sqrt(Tile.TILE_COUNT);if(b!==c)this._triggerCallback(!1);else if(0!==b%d)this._triggerCallback(!1);else if(b=this.tileWidth=b/d,b<Tile.MIN_SIZE)this._triggerCallback(!1);else{var e=0,f=this,c=document.createElement("canvas");c.width=this.tileWidth;c.height=this.tileWidth;for(var g=c.getContext("2d"),h=function(){e++;e==Tile.TILE_COUNT&&(f.loaded=!0,f._triggerCallback(!0))},k=0;k<Tile.TILE_COUNT;k++)g.clearRect(0,0,this.tileWidth,this.tileWidth),
g.drawImage(a,k%d*b,Math.floor(k/d)*b,b,b,0,0,b,b),this[k]=new Image,this[k].onload=h,this[k].src=c.toDataURL()}}};Micro.PositionMaker=function(a,b){function c(a){return"number"===typeof a}if(2>arguments.length||"number"!==typeof a||"number"!==typeof b||0>a||0>b)throw Error("Invalid parameter");var d=[Direction.NORTH,Direction.NORTHEAST,Direction.EAST,Direction.SOUTHEAST,Direction.SOUTH,Direction.SOUTHWEST,Direction.WEST,Direction.NORTHWEST,Direction.INVALID],e=function(f,g,h){if(0===arguments.length)return this.y=this.x=0,this;if(!(1!==arguments.length&&3!==arguments.length||f instanceof e))throw Error("Invalid parameter");
...
!0;break;case Direction.SOUTH:if(this.y<b-1)return this.y++,!0;break;case Direction.SOUTHWEST:if(this.y<b-1&&0<this.x)return this.y++,this.x--,!0;break;case Direction.WEST:if(0<this.x)return this.x--,!0;break;case Direction.NORTHWEST:if(0<this.y&&0<this.x)return this.y--,this.x--,!0}return!1};return e};Micro.GameMap=function(a,b,c){this.isIsland=!1;this.Direction=new Micro.Direction;this.Position=new Micro.PositionMaker(a,b);this.width=a;this.height=b;this.defaultValue=0;this.data=Array(this.width*this.height);this.value=new M_ARRAY_TYPE(this.width*this.height);this.cityCentreX=Math.floor(0.5*this.width);this.cityCentreY=Math.floor(0.5*this.height);this.pollutionMaxX=this.cityCentreX;this.pollutionMaxY=this.cityCentreY};
Micro.GameMap.prototype={constructor:Micro.GameMap,genFull:function(){for(var a=this.data.length;a--;)this.value[a]=this.data[a].getValue();return this.value},_calculateIndex:function(a,b){return a+b*this.width},testBounds:function(a,b){return 0<=a&&0<=b&&a<this.width&&b<this.height},getTile:function(a,b){var c=Error("Invalid parameter");if(1>arguments.length)throw c;"object"===typeof a&&(b=a.y,a=a.x);if(!this.testBounds(a,b))throw c;c=this._calculateIndex(a,b);c in this.data||(this.data[c]=new Micro.Tile(this.defaultValue));
return this.data[c]},getTileValue:function(a,b){var c=Error("Invalid parameter");if(1>arguments.length)throw c;"object"===typeof a&&(b=a.y,a=a.x);if(!this.testBounds(a,b))throw c;c=this._calculateIndex(a,b);c in this.data||(this.data[c]=new Micro.Tile(this.defaultValue));return this.data[c].getValue()},getTileFlags:function(a,b){var c=Error("Invalid parameter");if(1>arguments.length)throw c;"object"===typeof a&&(b=a.y,a=a.x);if(!this.testBounds(a,b))throw c;c=this._calculateIndex(a,b);c in this.data||
(this.data[c]=new Micro.Tile(this.defaultValue));return this.data[c].getFlags()},getTiles:function(a,b,c,d){var e=Error("Invalid parameter");if(3>arguments.length)throw e;3===arguments.length&&(d=c,c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw e;for(var e=[],f=b,g=b+d;f<g;f++){e[f-b]=[];for(var h=a,k=a+c;h<k;h++){var m=this._calculateIndex(h,f);m in this.data||(this.data[m]=new Micro.Tile(this.defaultValue));e[f-b].push(this.data[m])}}return e},getTileValues:function(a,b,c,d){var e=Error("Invalid parameter");
if(3>arguments.length)throw e;3===arguments.length&&(d=c,c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw e;for(var e=[],f=b,g=b+d;f<g;f++){e[f-b]=[];for(var h=a,k=a+c;h<k;h++){var m=this._calculateIndex(h,f);m in this.data||(this.data[m]=new Micro.Tile(this.defaultValue));e[f-b].push(this.data[m].getValue())}}return e},getTileFromMapOrDefault:function(a,b,c){switch(b){case this.Direction.NORTH:return 0<a.y?this.getTileValue(a.x,a.y-1):c;case this.Direction.EAST:return a.x<this.width-1?this.getTileValue(a.x+
1,a.y):c;case this.Direction.SOUTH:return a.y<this.height-1?this.getTileValue(a.x,a.y+1):c;case this.Direction.WEST:return 0<a.x?this.getTileValue(a.x-1,a.y):c;default:return c}},setTile:function(a,b,c,d){var e=Error("Invalid parameter");if(3>arguments.length)throw e;3===arguments.length&&(d=c,c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw e;e=this._calculateIndex(a,b);e in this.data||(this.data[e]=new Micro.Tile(this.defaultValue));this.data[e].set(c,d)},setTo:function(a,b,c){var d=Error("Invalid parameter");
if(2>arguments.length)throw d;void 0===c&&(c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw d;d=this._calculateIndex(a,b);this.data[d]=c},setTileValue:function(a,b,c){var d=Error("Invalid parameter");if(2>arguments.length)throw d;2===arguments.length&&(c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw d;d=this._calculateIndex(a,b);d in this.data||(this.data[d]=new Micro.Tile(this.defaultValue));this.data[d].setValue(c)},setTileFlags:function(a,b,c){var d=Error("Invalid parameter");if(2>arguments.length)throw d;
2===arguments.length&&(c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw d;d=this._calculateIndex(a,b);d in this.data||(this.data[d]=new Micro.Tile(this.defaultValue));this.data[d].setFlags(c)},addTileFlags:function(a,b,c){var d=Error("Invalid parameter");if(2>arguments.length)throw d;2===arguments.length&&(c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw d;d=this._calculateIndex(a,b);d in this.data||(this.data[d]=new Micro.Tile(this.defaultValue));this.data[d].addFlags(c)},removeTileFlags:function(a,
b,c){var d=Error("Invalid parameter");if(2>arguments.length)throw d;2===arguments.length&&(c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw d;d=this._calculateIndex(a,b);d in this.data||(this.data[d]=new Micro.Tile(this.defaultValue));this.data[d].removeFlags(c)},putZone:function(a,b,c,d){var e=Error("Invalid parameter");if(!this.testBounds(a,b)||!this.testBounds(a-1+d,b-1+d))throw e;c=c-1-d;for(var e=a-1,f=b-1,g=f;g<f+d;g++)for(var h=e;h<e+d;h++)h===a&&g===b?this.setTo(h,g,new Micro.Tile(c,Tile.BNCNBIT|
Tile.ZONEBIT)):this.setTo(h,g,new Micro.Tile(c,Tile.BNCNBIT)),c+=1}};Micro.TERRAIN_CREATE_ISLAND=0;Micro.TERRAIN_TREE_LEVEL=-1;Micro.TERRAIN_LAKE_LEVEL=-1;Micro.TERRAIN_CURVE_LEVEL=0;Micro.ISLAND_RADIUS=18;
Micro.generateMap=function(){this.SRMatrix=[[0,0,Tile.REDGE,Tile.REDGE,0,0],[0,Tile.REDGE,Tile.RIVER,Tile.RIVER,Tile.REDGE,0],[Tile.REDGE,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.REDGE],[Tile.REDGE,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.REDGE],[0,Tile.REDGE,Tile.RIVER,Tile.RIVER,Tile.REDGE,0],[0,0,Tile.REDGE,Tile.REDGE,0,0]];this.BRMatrix=[[0,0,0,Tile.REDGE,Tile.REDGE,Tile.REDGE,0,0,0],[0,0,Tile.REDGE,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.REDGE,0,0],[0,Tile.REDGE,Tile.RIVER,Tile.RIVER,
Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.REDGE,0],[Tile.REDGE,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.REDGE],[Tile.REDGE,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.CHANNEL,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.REDGE],[Tile.REDGE,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.REDGE],[0,Tile.REDGE,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.REDGE,0],[0,0,Tile.REDGE,Tile.RIVER,Tile.RIVER,Tile.RIVER,Tile.REDGE,0,0],[0,
0,0,Tile.REDGE,Tile.REDGE,Tile.REDGE,0,0,0]]};
Micro.generateMap.prototype={constructor:Micro.generateMap,construct:function(a,b){this.map=new Micro.GameMap(a||Micro.MAP_WIDTH,b||Micro.MAP_HEIGHT);Micro.TERRAIN_CREATE_ISLAND=Random.getRandom(2)-1;if(0>Micro.TERRAIN_CREATE_ISLAND&&10>Random.getRandom(100))return this.makeIsland(),this.map;1===Micro.TERRAIN_CREATE_ISLAND?this.makeNakedIsland():this.clearMap();if(0!==Micro.TERRAIN_CURVE_LEVEL){var c=40+Random.getRandom(this.map.width-80),d=33+Random.getRandom(this.map.height-67),c=new this.map.Position(c,
d);this.doRivers(c)}0!==Micro.TERRAIN_LAKE_LEVEL&&this.makeLakes();this.smoothRiver();0!==Micro.TERRAIN_TREE_LEVEL&&this.doTrees();return this.map},clearMap:function(){for(var a=0;a<this.map.width;a++)for(var b=0;b<this.map.height;b++)this.map.setTo(a,b,new Micro.Tile(Tile.DIRT))},clearUnnatural:function(){for(var a=0;a<this.map.width;a++)for(var b=0;b<this.map.height;b++)this.map.getTileValue(a,b)>Tile.WOODS&&this.map.setTo(a,b,new Micro.Tile(Tile.DIRT))},makeNakedIsland:function(){this.map.isIsland=
!0;var a=Micro.ISLAND_RADIUS,b,c;for(b=0;b<this.map.width;b++)for(c=0;c<this.map.height;c++)5>b||b>=this.map.width-5||5>c||c>=this.map.height-5?this.map.setTo(b,c,new Micro.Tile(Tile.RIVER)):this.map.setTo(b,c,new Micro.Tile(Tile.DIRT));for(b=0;b<this.map.width-5;b+=2)c=Random.getERandom(a),this.plopBRiver(new this.map.Position(b,c)),c=this.map.height-10-Random.getERandom(a),this.plopBRiver(new this.map.Position(b,c)),this.plopSRiver(new this.map.Position(b,0)),this.plopSRiver(new this.map.Position(b,
this.map.height-6));for(c=0;c<this.map.height-5;c+=2)b=Random.getERandom(a),this.plopBRiver(new this.map.Position(b,c)),b=this.map.width-10-Random.getERandom(a),this.plopBRiver(new this.map.Position(b,c)),this.plopSRiver(new this.map.Position(0,c)),this.plopSRiver(new this.map.Position(this.map.width-6,c))},makeIsland:function(){this.makeNakedIsland();this.smoothWater();this.smoothRiver();this.doTrees()},makeLakes:function(){var a;for(a=0>Micro.TERRAIN_LAKE_LEVEL?Random.getRandom(10):Micro.TERRAIN_LAKE_LEVEL/
2;0<a;){var b=Random.getRandom(this.map.width-21)+10,c=Random.getRandom(this.map.height-20)+10;this.makeSingleLake(new this.map.Position(b,c));a--}},makeSingleLake:function(a){for(var b=Random.getRandom(12)+2;0<b;){var c=new this.map.Position(a,Random.getRandom(12)-6,Random.getRandom(12)-6);Random.getRandom(4)?this.plopSRiver(c):this.plopBRiver(c);b--}},treeSplash:function(a,b){var c;c=0>Micro.TERRAIN_TREE_LEVEL?Random.getRandom(150)+50:Random.getRandom(100+2*Micro.TERRAIN_TREE_LEVEL)+50;for(var d=
new this.map.Position(a,b);0<c;){var e=Direction.NORTH+Random.getRandom(7);d.move(e);if(!this.map.testBounds(d.x,d.y))break;this.map.getTileValue(d)===Tile.DIRT&&this.map.setTo(d,new Micro.Tile(Tile.WOODS,Tile.BLBNBIT));c--}},doTrees:function(){var a;a=0>Micro.TERRAIN_TREE_LEVEL?Random.getRandom(100)+50:Micro.TERRAIN_TREE_LEVEL+3;for(var b=0;b<a;b++){var c=Random.getRandom(this.map.width-1),d=Random.getRandom(this.map.height-1);this.treeSplash(c,d)}this.smoothTrees();this.smoothTrees()},smoothRiver:function(){for(var a=
[-1,0,1,0],b=[0,1,0,-1],c=[13|Tile.BULLBIT,13|Tile.BULLBIT,17|Tile.BULLBIT,15|Tile.BULLBIT,5|Tile.BULLBIT,2,19|Tile.BULLBIT,17|Tile.BULLBIT,9|Tile.BULLBIT,11|Tile.BULLBIT,2,13|Tile.BULLBIT,7|Tile.BULLBIT,9|Tile.BULLBIT,5|Tile.BULLBIT,2],d=0;d<this.map.width;d++)for(var e=0;e<this.map.height;e++)if(this.map.getTileValue(d,e)===Tile.REDGE){for(var f=0,g=0;4>g;g++){var f=f<<1,h=d+a[g],k=e+b[g];this.map.testBounds(h,k)&&this.map.getTileValue(h,k)!==Tile.DIRT&&(this.map.getTileValue(h,k)<Tile.WOODS_LOW||
this.map.getTileValue(h,k)>Tile.WOODS_HIGH)&&f++}f=c[f&15];f!==Tile.RIVER&&Random.getRandom(1)&&f++;this.map.setTo(d,e,new Micro.Tile(f))}},isTree:function(a){return a>=Tile.WOODS_LOW&&a<=Tile.WOODS_HIGH},smoothTrees:function(){for(var a=0;a<this.map.width;a++)for(var b=0;b<this.map.height;b++)this.isTree(this.map.getTileValue(a,b))&&this.smoothTreesAt(a,b,!1)},smoothTreesAt:function(a,b,c){var d=[-1,0,1,0],e=[0,1,0,-1],f=[0,0,0,34,0,0,36,35,0,32,0,33,30,31,29,37];if(this.isTree(this.map.getTileValue(a,
b))){for(var g=0,h=0;4>h;h++){var g=g<<1,k=a+d[h],m=b+e[h];this.map.testBounds(k,m)&&this.isTree(this.map.getTileValue(k,m))&&g++}(d=f[g&15])?(d!==Tile.WOODS&&a+b&1&&(d-=8),this.map.setTo(a,b,new Micro.Tile(d,Tile.BLBNBIT))):c||this.map.setTo(a,b,new Micro.Tile(d))}},doRivers:function(a){var b=Direction.NORTH+2*Random.getRandom(3);this.doBRiver(a,b,b);var b=Direction.rotate180(b),c=this.doBRiver(a,b,b),b=Direction.NORTH+2*Random.getRandom(3);this.doSRiver(a,b,c)},doBRiver:function(a,b,c){var d,e;
0>Micro.TERRAIN_CURVE_LEVEL?(d=100,e=200):(d=Micro.TERRAIN_CURVE_LEVEL+10,e=Micro.TERRAIN_CURVE_LEVEL+100);for(a=new this.map.Position(a);this.map.testBounds(a.x+4,a.y+4);)this.plopBRiver(a),10>Random.getRandom(d)?c=b:(90<Random.getRandom(e)&&(c=Direction.rotate45(c)),90<Random.getRandom(e)&&(c=Direction.rotate45(c,7))),a.move(c);return c},doSRiver:function(a,b,c){var d,e;0>Micro.TERRAIN_CURVE_LEVEL?(d=100,e=200):(d=Micro.TERRAIN_CURVE_LEVEL+10,e=Micro.TERRAIN_CURVE_LEVEL+100);for(a=new this.map.Position(a);this.map.testBounds(a.x+
3,a.y+3);)this.plopSRiver(a),10>Random.getRandom(d)?c=b:(90<Random.getRandom(e)&&(c=Direction.rotate45(c)),90<Random.getRandom(e)&&(c=Direction.rotate45(c,7))),a.move(c);return c},putOnMap:function(a,b,c){if(0!==a&&this.map.testBounds(b,c)){var d=this.map.getTileValue(b,c);d!==Tile.DIRT&&(d===Tile.RIVER&&a!==Tile.CHANNEL||d===Tile.CHANNEL)||this.map.setTo(b,c,new Micro.Tile(a))}},plopBRiver:function(a){for(var b=0;9>b;b++)for(var c=0;9>c;c++)this.putOnMap(this.BRMatrix[c][b],a.x+b,a.y+c)},plopSRiver:function(a){for(var b=
0;6>b;b++)for(var c=0;6>c;c++)this.putOnMap(this.SRMatrix[c][b],a.x+b,a.y+c)},smoothWater:function(){var a,b,c,d,e;for(a=0;a<this.map.width;a++)for(b=0;b<this.map.height;b++)if(c=this.map.getTileValue(a,b),c>=Tile.WATER_LOW&&c<=Tile.WATER_HIGH)for(d=new this.map.Position(a,b),e=Direction.BEGIN;e<Direction.END;e=Direction.increment90(e))if(c=this.map.getTileFromMapOrDefault(d,e,Tile.WATER_LOW),c<Tile.WATER_LOW||c>Tile.WATER_HIGH){this.map.setTo(a,b,new Micro.Tile(Tile.REDGE));break}for(a=0;a<this.map.width;a++)for(b=
0;b<this.map.height;b++)if(c=this.map.getTileValue(a,b),c!==Tile.CHANNEL&&c>=Tile.WATER_LOW&&c<=Tile.WATER_HIGH){var f=!0;d=new this.map.Position(a,b);for(e=Direction.BEGIN;e<Direction.END;e=Direction.increment90(e))if(c=this.map.getTileFromMapOrDefault(d,e,Tile.WATER_LOW),c<Tile.WATER_LOW||c>Tile.WATER_HIGH){f=!1;break}f&&this.map.setTo(a,b,new Micro.Tile(Tile.RIVER))}for(a=0;a<this.map.width;a++)for(b=0;b<this.map.height;b++)if(c=this.map.getTileValue(a,b),c>=Tile.WOODS_LOW&&c<=Tile.WOODS_HIGH)for(d=
new this.map.Position(a,b),e=Direction.BEGIN;e<Direction.END;e=Direction.increment90(e))if(c=this.map.getTileFromMapOrDefault(d,e,Tile.TILE_INVALID),c===Tile.RIVER||c===Tile.CHANNEL){this.map.setTo(a,b,new Micro.Tile(Tile.REDGE));break}}};Micro.SpriteLoader=function(a){this.src=a;this._errorCallback=this._loadCallback=null};
Micro.SpriteLoader.prototype={constructor:Micro.SpriteLoader,_loadCB:function(){var a=this._loadCallback;this._errorCallback=this._loadCallback=null;a(this._spriteSheet)},_errorCB:function(){var a=this._errorCallback;this._spriteSheet=this._errorCallback=this._loadCallback=null;a()},load:function(a,b){this._loadCallback=a;this._errorCallback=b;this._spriteSheet=new Image;this._spriteSheet.onerror=this._errorCB.bind(this);this._spriteSheet.onload=this._loadCB.bind(this);this._spriteSheet.src=this.src}};Micro.SplashCanvas=function(){this.canvas=document.createElement("canvas");this.canvas.id=Micro.MAP_BIG_DEFAULT_ID;this.canvas.width=Micro.MAP_DEFAULT_WIDTH;this.canvas.height=Micro.MAP_DEFAULT_HEIGHT;var a=document.getElementById("SplashCanvas");a.removeChild(a.firstChild);a.appendChild(this.canvas)};
Micro.SplashCanvas.prototype={constructor:Micro.SplashCanvas,init:function(a,b){this._tileSet=b;this.paint(a)},paintTile:function(a,b,c,d){a=this._tileSet[a];this.canvas.getContext("2d").drawImage(a,3*b,3*c,3,3)},clearMap:function(){var a=this.canvas.getContext("2d");a.fillStyle="black";a.fillRect(0,0,this.canvas.width,this.canvas.height)},paint:function(a){this.canvas.getContext("2d").clearRect(0,0,this.canvas.width,this.canvas.height);for(var b=a.height,c;b--;)for(c=a.width;c--;)this.paintTile(a.getTileValue(c,
b),c,b)}};Micro.SplashScreen=function(a,b){this.debug=document.getElementById("debug");this.tileSet=a;this.spriteSheet=b;this.mapGen=new Micro.generateMap;this.map=this.mapGen.construct();document.getElementById("splashGenerate").addEventListener("click",this.regenerateMap.bind(this),!1);document.getElementById("splashPlay").addEventListener("click",this.playMap.bind(this),!1);for(var c=document.getElementsByClassName("awaitGeneration"),d=0;d<c.length;d++)c[d].style.display="block";this.splashCanvas=new Micro.SplashCanvas;
this.splashCanvas.init(this.map,a)};
Micro.SplashScreen.prototype={constructor:Micro.SplashScreen,regenerateMap:function(){this.splashCanvas.clearMap();this.map=this.mapGen.construct();this.splashCanvas.paint(this.map)},playMap:function(){for(var a=0,b=document.getElementsByName("difficulty"),c=0;c<b.length;c++)"radio"===b[c].type&&b[c].checked&&(a=parseInt(b[c].value));document.getElementById("splashGenerate").removeEventListener("click",this.regenerateMap.bind(this),!1);document.getElementById("splashPlay").removeEventListener("click",this.playMap.bind(this),
!1);document.getElementById("splashContainer").innerHTML="";new Micro.Game(this.map,this.tileSet,this.spriteSheet,a)}};Micro.unwrapTile=function(a){return function(b){b instanceof Micro.Tile&&(b=b.getValue());return a.call(null,b)}};Micro.canBulldoze=Micro.unwrapTile(function(a){return a>=Tile.FIRSTRIVEDGE&&a<=Tile.LASTRUBBLE||a>=Tile.POWERBASE+2&&a<=Tile.POWERBASE+12||a>=Tile.TINYEXP&&a<=Tile.LASTTINYEXP+2});Micro.isCommercial=Micro.unwrapTile(function(a){return a>=Tile.COMBASE&&a<Tile.INDBASE});Micro.isDriveable=Micro.unwrapTile(function(a){return a>=Tile.ROADBASE&&a<=Tile.LASTRAIL||a===Tile.RAILHPOWERV||a===Tile.RAILVPOWERH});
...
Micro.smoothDitherMap=function(a,b){for(var c=0;c<a.width;c++)for(var d=0;d<a.height;d++){var e=0;0<c&&(e+=a.get(c-1,d));c<a.width-1&&(e+=a.get(c+1,d));0<d&&(e+=a.get(c,d-1));d<a.height-1&&(e+=a.get(c,d+1));e=e+a.get(c,d)>>2;255<e&&(e=255);b.set(c,d,e)}};Micro.smoothTemp1ToTemp2=function(a){Micro.smoothDitherMap(a.tempMap1,a.tempMap2)};Micro.smoothTemp2ToTemp1=function(a){Micro.smoothDitherMap(a.tempMap2,a.tempMap1)};
Micro.smoothTerrain=function(a){var b=a.tempMap3;a=a.terrainDensityMap;for(var c=0;c<a.width;c++)for(var d=0;d<a.height;d++){var e=0;0<c&&(e+=b.get(c-1,d));c<a.width-1&&(e+=b.get(c+1,d));0<d&&(e+=b.get(c,d-1));d<a.height-1&&(e+=b.get(c,d+1));e=Math.floor(Math.floor(e/4)+b.get(c,d)/2);a.set(c,d,e)}};
Micro.pollutionTerrainLandValueScan=function(a,b,c){var d=c.tempMap1,e=c.tempMap3,f=c.landValueMap,g=c.terrainDensityMap,h=c.pollutionDensityMap,k=c.crimeRateMap,m,l;e.clear();var n=0,p=0;for(m=0;m<f.width;m++)for(l=0;l<f.height;l++){for(var q=0,w=!1,r=2*m,s=2*l,u=r;u<=r+1;u++)for(var t=s;t<=s+1;t++){var v=a.getTileValue(u,t);v>Tile.DIRT&&(v<Tile.RUBBLE?(v=e.get(m>>1,l>>1),e.set(m>>1,l>>1,v+15)):(q+=Micro.getPollutionValue(v),v>=Tile.ROADBASE&&(w=!0)))}q=Math.min(q,255);d.set(m,l,q);w?(q=34-Math.floor(Micro.getCityCentreDistance(a,
r,s)/2),q<<=2,q+=g.get(m>>1,l>>1),q-=h.get(m,l),190<k.get(m,l)&&(q-=20),q=Micro.clamp(q,1,250),f.set(m,l,q),n+=q,p++):f.set(m,l,0)}b.landValueAverage=0<p?Math.floor(n/p):0;Micro.smoothTemp1ToTemp2(c);Micro.smoothTemp2ToTemp1(c);for(m=g=f=e=0;m<h.mapWidth;m+=h.blockSize)for(l=0;l<h.mapHeight;l+=h.blockSize)if(k=d.worldGet(m,l),h.worldSet(m,l,k),0!==k&&(f++,g+=k,k>e||k===e&&Random.getChance(3)))e=k,a.pollutionMaxX=m,a.pollutionMaxY=l;b.pollutionAverage=f?Math.floor(g/f):0;Micro.smoothTerrain(c)};
Micro.smoothStationMap=function(a){for(var b=new Micro.BlockMap(a),c=0;c<b.width;c++)for(var d=0;d<b.height;d++){var e=0;0<c&&(e+=b.get(c-1,d));c<b.width-1&&(e+=b.get(c+1,d));0<d&&(e+=b.get(c,d-1));d<b.height-1&&(e+=b.get(c,d+1));e=b.get(c,d)+Math.floor(e/4);a.set(c,d,Math.floor(e/2))}};
Micro.crimeScan=function(a,b){var c=b.policeStationMap,d=b.crimeRateMap,e=b.landValueMap,f=b.populationDensityMap;Micro.smoothStationMap(c);Micro.smoothStationMap(c);Micro.smoothStationMap(c);for(var g=0,h=0,k=0;k<d.mapWidth;k+=d.blockSize)for(var m=0;m<d.mapHeight;m+=d.blockSize){var l=e.worldGet(k,m);0<l?(++h,l=128-l,l+=f.worldGet(k,m),l=Math.min(l,300),l-=c.worldGet(k,m),l=Micro.clamp(l,0,250),d.worldSet(k,m,l),g+=l):d.worldSet(k,m,0)}a.crimeAverage=0<h?Math.floor(g/h):0;b.policeStationEffectMap=
new Micro.BlockMap(c)};Micro.computeComRateMap=function(a,b){for(var c=b.comRateMap,d=0;d<c.width;d++)for(var e=0;e<c.height;e++){var f=Math.floor(Micro.getCityCentreDistance(a,8*d,8*e)/2),f=4*f,f=64-f;c.set(d,e,f)}};Micro.getPopulationDensity=function(a,b,c,d){return d<Tile.COMBASE?Residential.getZonePopulation(a,b,c,d):d<Tile.INDBASE?8*Commercial.getZonePopulation(a,b,c,d):d<Tile.PORTBASE?8*Industrial.getZonePopulation(a,b,c,d):0};
Micro.populationDensityScan=function(a,b){var c=b.tempMap1,d=b.tempMap2;c.clear();for(var e=0,f=0,g=0,h=0;h<a.width;h++)for(var k=0;k<a.height;k++){var m=a.getTile(h,k);m.isZone()&&(m=m.getValue(),m=8*Micro.getPopulationDensity(a,h,k,m),m=Math.min(m,254),c.worldSet(h,k,m),e+=h,f+=k,g++)}Micro.smoothTemp1ToTemp2(b);Micro.smoothTemp2ToTemp1(b);Micro.smoothTemp1ToTemp2(b);b.populationDensityMap=new Micro.BlockMap(d,function(a){return 2*a});Micro.computeComRateMap(a,b);0<g?(a.cityCentreX=Math.floor(e/
g),a.cityCentreY=Math.floor(f/g)):(a.cityCentreX=Math.floor(0.5*a.width),a.cityCentreY=Math.floor(0.5*a.height))};Micro.fireAnalysis=function(a){var b=a.fireStationMap;Micro.smoothStationMap(b);Micro.smoothStationMap(b);Micro.smoothStationMap(b);a.fireStationEffectMap=new Micro.BlockMap(b)};Micro.Residential=function(a){var b=function(a,b,c,d){d instanceof Micro.Tile&&(d=(new Micro.Tile).getValue());if(d===Tile.FREEZ){for(var e=0,f=b-1;f<=b+1;f++)for(var p=c-1;p<=c+1;p++)if(f!==b||p!==c)d=a.getTileValue(f,p),d>=Tile.LHTHR&&d<=Tile.HHTHR&&(e+=1);return e}return 8*(Math.floor((d-Tile.RZB)/9)%4+1)+16},c=[0,3,6,1,4,7,2,5,8],d=function(a,b,d,e,f,n,p){if(0!==f)if(16<f)Micro.putZone(a,b,d,9*(4*n+Math.floor((f-24)/8))+Tile.RZB,p),Micro.incRateOfGrowth(e,b,d,-8);else if(16===f){a.setTo(b,d,new Micro.Tile(Tile.FREEZ,
Tile.BLBNCNBIT|Tile.ZONEBIT));for(p=d-1;p<=d+1;p++)for(f=b-1;f<=b+1;f++)f===b&&p===d||a.setTo(b,d,new Micro.Tile(Tile.LHTHR+n+Random.getRandom(2),Tile.BLBNCNBIT));Micro.incRateOfGrowth(e,b,d,-8)}else for(n=0,Micro.incRateOfGrowth(e,b,d,-1),f=b-1;f<=b+1;f++)for(p=d-1;p<=d+1;p++){e=a.getTileValue(f,p);if(e>=Tile.LHTHR&&e<=Tile.HHTHR){a.setTo(f,p,new Micro.Tile(c[n]+Tile.RESBASE,Tile.BLBNCNBIT));return}n+=1}},e=function(c,e,f,m){var l;a.census.resZonePop+=1;l=c.getTileValue(e,f);var n=b(c,e,f,l);a.census.resPop+=
n;var p=c.getTile(e,f).isPowered();m=Micro.ROUTE_FOUND;if(n>Random.getRandom(35)&&(m=a.traffic.makeTraffic(e,f,a.blockMaps,Micro.isCommercial),m===Micro.NO_ROAD_FOUND)){l=Micro.getLandPollutionValue(a.blockMaps,e,f);d(c,e,f,a.blockMaps,n,l,p);return}if(l===Tile.FREEZ||Random.getChance(7)){l=a.blockMaps;if(m===Micro.NO_ROAD_FOUND)l=-3E3;else{var q=l.landValueMap.worldGet(e,f),q=q-l.pollutionDensityMap.worldGet(e,f),q=0>q?0:Math.min(32*q,6E3);l=q-3E3}l=a.valves.resValve+l;p||(l=-500);if(m&&-350<l&&
l-26380>Random.getRandom16Signed())if(0===n&&0===(Random.getRandom16()&3))0<a.census.needHospital&&(Micro.putZone(c,e,f,Tile.HOSPITAL,p),a.census.needHospital=0);else a:{if(l=Micro.getLandPollutionValue(a.blockMaps,e,f),m=a.blockMaps,!(128<m.pollutionDensityMap.worldGet(e,f))){if(c.getTileValue(e,f)===Tile.FREEZ){if(8>n){for(var p=n=0,q=[0,-1,0,1,-1,1,-1,0,1],w=[0,-1,-1,-1,0,0,1,1,1],r=0;9>r;r++){var s;s=c;var u=e+q[r],t=f+w[r],v=[0,1,0,-1],A=[-1,0,1,0],x=s.getTileValue(u,t);if(x<Tile.RESBASE||x>
Tile.RESBASE+8)s=-1;else{for(var z=1,y=0;4>y;y++)x=s.getTileValue(u+v[y],t+A[y]),x!==Tile.DIRT&&x<=Tile.LASTROAD&&(z+=1);s=z}s>p?(p=s,n=r):s===p&&Random.getChance(7)&&(n=r)}0<n&&c.setTo(e+q[n],f+w[n],new Micro.Tile(Tile.HOUSE+Random.getRandom(2)+3*l,Tile.BLBNCNBIT));Micro.incRateOfGrowth(m,e,f,1);break a}if(64<m.populationDensityMap.worldGet(e,f)){Micro.putZone(c,e,f,9*(4*l+0)+Tile.RZB,p);Micro.incRateOfGrowth(m,e,f,8);break a}}40>n&&(Micro.putZone(c,e,f,9*(4*l+(Math.floor(n/8)-1))+Tile.RZB,p),Micro.incRateOfGrowth(m,
e,f,8))}}else 350>l&&l+26380<Random.getRandom16Signed()&&(l=Micro.getLandPollutionValue(a.blockMaps,e,f),d(c,e,f,a.blockMaps,n,l,p))}},f=function(b,c,d,e){a.census.hospitalPop+=1;-1===a.census.needHospital&&0===Random.getRandom(20)&&Micro.putZone(b,c,d,Tile.FREEZ)};return{registerHandlers:function(a,b){a.addAction(Micro.isResidentialZone,e);a.addAction(Micro.HOSPITAL,f);b.addAction(Tile.HOSPITAL,15,3)},getZonePopulation:b}};Micro.Commercial=function(a){var b=function(a,b,c,d){d instanceof Micro.Tile&&(d=(new Micro.Tile).getValue());return d===Tile.COMCLR?0:Math.floor((d-Tile.CZB)/9)%5+1},c=function(a,b,c,d,k,m,l){1<k?(Micro.putZone(a,b,c,9*(5*m+(k-2))+Tile.CZB,l),Micro.incRateOfGrowth(d,b,c,-8)):1===k&&(Micro.putZone(a,b,c,Tile.COMCLR,l),Micro.incRateOfGrowth(d,b,c,-8))},d=function(d,f,g,h){var k;a.census.comZonePop+=1;h=d.getTileValue(f,g);h=b(d,f,g,h);a.census.comPop+=h;var m=d.getTile(f,g).isPowered(),l=Micro.ROUTE_FOUND;
if(h>Random.getRandom(5)&&(l=a.traffic.makeTraffic(f,g,a.blockMaps,Micro.isIndustrial),l===Micro.NO_ROAD_FOUND)){k=Micro.getLandPollutionValue(a.blockMaps,f,g);c(d,f,g,a.blockMaps,h,k,m);return}if(Random.getChance(7))if(k=l===Micro.NO_ROAD_FOUND?-3E3:a.blockMaps.comRateMap.worldGet(f,g),k=a.valves.comValve+k,m||(k=-500),l&&-350<k&&k-26380>Random.getRandom16Signed()){k=Micro.getLandPollutionValue(a.blockMaps,f,g);var l=a.blockMaps,n=l.landValueMap.worldGet(f,g);!(h>n>>5)&&5>h&&(Micro.putZone(d,f,g,
9*(5*k+h)+Tile.CZB,m),Micro.incRateOfGrowth(l,f,g,8))}else 350>k&&k+26380<Random.getRandom16Signed()&&(k=Micro.getLandPollutionValue(a.blockMaps,f,g),c(d,f,g,a.blockMaps,h,k,m))};return{registerHandlers:function(a,b){a.addAction(Micro.isCommercialZone,d)},getZonePopulation:b}};Micro.Industrial=function(a){var b=function(a,b,c,d){d instanceof Micro.Tile&&(d=(new Micro.Tile).getValue());return d===Tile.INDCLR?0:Math.floor((d-Tile.IZB)/9)%4+1},c=function(a,b,c,d,e,f,g){1<e?(Micro.putZone(a,b,c,9*(4*f+(e-2))+Tile.IZB,g),Micro.incRateOfGrowth(d,b,c,-8)):1===e&&(Micro.putZone(a,b,c,Tile.INDCLR,g),Micro.incRateOfGrowth(d,b,c,-8))},d=[!0,!1,!0,!0,!1,!1,!0,!0],e=[-1,0,1,0,0,0,0,1],f=[-1,0,-1,-1,0,0,-1,-1],g=function(g,k,m,l){a.census.indZonePop+=1;var n=g.getTileValue(k,m);l=b(g,
k,m,n);a.census.indPop+=l;var p=g.getTile(k,m).isPowered();n<Tile.IZB||(n=n-Tile.IZB>>3,d[n]&&p?g.addTileFlags(k+e[n],m+f[n],Tile.ASCBIT):(g.addTileFlags(k+e[n],m+f[n],Tile.BNCNBIT),g.removeTileFlags(k+e[n],m+f[n],Tile.ANIMBIT)));n=Micro.ROUTE_FOUND;if(l>Random.getRandom(5)&&(n=a.traffic.makeTraffic(k,m,a.blockMaps,Micro.isResidential),n===Micro.NO_ROAD_FOUND)){c(g,k,m,a.blockMaps,l,Random.getRandom16()&1,p);return}if(Random.getChance(7)){var q;q=n===Micro.NO_ROAD_FOUND?-1E3:0;q=a.valves.indValve+
q;p||(q=-500);n&&-350<q&&q-26380>Random.getRandom16Signed()?(n=a.blockMaps,q=Random.getRandom16()&1,4>l&&(Micro.putZone(g,k,m,9*(4*q+l)+Tile.IZB,p),Micro.incRateOfGrowth(n,k,m,8))):350>q&&q+26380<Random.getRandom16Signed()&&c(g,k,m,a.blockMaps,l,Random.getRandom16()&1,p)}};return{registerHandlers:function(a,b){a.addAction(Micro.isIndustrialZone,g)},getZonePopulation:b}};Micro.MiscTiles=function(a){var b=[-1,0,1,0],c=[0,-1,0,1],d=function(d,e,f,g){a.census.firePop+=1;if(0===(Random.getRandom16()&3)){for(g=0;4>g;g++)if(Random.getChance(7)&&d.testBounds(e+b[g],f+c[g])){var n=d.getTile(e,f);n.isCombustible()&&(n.isZone()&&(Micro.fireZone(d,e,f,a.blockMaps),n.getValue()>Tile.IZB&&a.spriteManager.makeExplosionAt(e,f)),d.setTo(Micro.randomFire()))}n=10;g=a.blockMaps.fireStationEffectMap.worldGet(e,f);100<g?n=1:20<g?n=2:0<g&&(n=3);0===Random.getRandom(n)&&d.setTo(e,f,Micro.randomRubble())}},
e=function(a,b,c,d){Random.getChance(4095)&&a.setTo(b,c,new Micro.Tile(Tile.DIRT))},f=function(b,c,d,e){a.disasterManager.doFlood(c,d,a.blockMaps)},g=function(a,b,c,d){a.getTileValue(b,c);a.setTo(b,c,Micro.randomRubble())};return{registerHandlers:function(a,b){a.addAction(Micro.isFire,d,!0);a.addAction(Tile.RADTILE,e,!0);a.addAction(Micro.isFlood,f,!0);a.addAction(Micro.isManualExplosion,g,!0)}}};Micro.Road=function(a){var b=function(a,b,c,d,e,f,g){for(var h=0;7>h;h++){var k=b+d[h],l=c+e[h];a.testBounds(k,l)&&a.getTileValue(k,l)===(f[h]&Tile.BIT_MASK)&&a.setTileValue(g[h])}},c=function(a,b,c,d,e,f,g){for(var h=0;7>h;h++){var k=b+d[h],l=c+e[h];a.testBounds(k,l)&&(k=a.getTileValue(k,l),k!==Tile.CHANNEL&&(k&15)!==(f[h]&15)||a.setTileValue(g[h]))}},d=[0,1,0,0,0,0,1],e=[-2,-2,-1,0,1,2,2],f=[Tile.VBRDG0|Tile.BULLBIT,Tile.VBRDG1|Tile.BULLBIT,Tile.RIVER,Tile.BRWV|Tile.BULLBIT,Tile.RIVER,Tile.VBRDG2|
Tile.BULLBIT,Tile.VBRDG3|Tile.BULLBIT],g=[Tile.VBRIDGE|Tile.BULLBIT,Tile.RIVER,Tile.VBRIDGE|Tile.BULLBIT,Tile.VBRIDGE|Tile.BULLBIT,Tile.VBRIDGE|Tile.BULLBIT,Tile.VBRIDGE|Tile.BULLBIT,Tile.RIVER],h=[-2,2,-2,-1,0,1,2],k=[-1,-1,0,0,0,0,0],m=[Tile.HBRDG1|Tile.BULLBIT,Tile.HBRDG3|Tile.BULLBIT,Tile.HBRDG0|Tile.BULLBIT,Tile.RIVER,Tile.BRWH|Tile.BULLBIT,Tile.RIVER,Tile.HBRDG2|Tile.BULLBIT],l=[Tile.RIVER,Tile.RIVER,Tile.HBRIDGE|Tile.BULLBIT,Tile.HBRIDGE|Tile.BULLBIT,Tile.HBRIDGE|Tile.BULLBIT,Tile.HBRIDGE|
...
Micro.BaseTool.prototype={constructor:Micro.BaseTool,init:function(a,b,c,d){Object.defineProperty(this,"toolCost",Micro.makeConstantDescriptor(a));this.result=null;this.isDraggable=d||!1;this._shouldAutoBulldoze=c;this._map=b;this._worldEffects=new Micro.WorldEffects(b);this._applicationCost=0},clear:function(){this._applicationCost=0;this._worldEffects.clear();this.result=null},addCost:function(a){this._applicationCost+=a},doAutoBulldoze:function(a,b){if(this._shouldAutoBulldoze){var c=this._worldEffects.getTile(a,
b);c.isBulldozable()&&(c=Micro.normalizeRoad(c),c>=Tile.TINYEXP&&c<=Tile.LASTTINYEXP||c<Tile.HBRIDGE&&c!==Tile.DIRT)&&(this.addCost(1),this._worldEffects.setTile(a,b,Tile.DIRT))}},apply:function(a,b){this._worldEffects.apply();a.spend(this._applicationCost,b);b.sendMessage(Messages.DID_TOOL);this.clear()},modifyIfEnoughFunding:function(a,b){if(this.result!==this.TOOLRESULT_OK)return!1;if(a.totalFunds<this._applicationCost)return this.result=this.TOOLRESULT_NO_MONEY,!1;this.apply.call(this,a,b);return!0},
...
b,Tile.VRAILROAD|Tile.BURNBIT|Tile.BULLBIT);break;default:return this.TOOLRESULT_FAILED}this.addCost(d);this.checkZoneConnections(a,b);return this.TOOLRESULT_OK};Micro.RoadTool.prototype.doTool=function(a,b,c,d){this.result=this.layRoad(a,b)};Micro.QueryTool=function(a){Micro.BaseTool.call(this);this.init(0,a,!1,!1)};var debug=!0;Micro.QueryTool.prototype=Object.create(Micro.BaseTool.prototype);Micro.QueryTool.prototype.classifyPopulationDensity=function(a,b,c){a=c.populationDensityMap.worldGet(a,b);debug&&(document.getElementById("queryDensityRaw").innerHTML=a);a=a>>6&3;document.getElementById("queryDensity").innerHTML=TXT.densityStrings[a]};
Micro.QueryTool.prototype.classifyLandValue=function(a,b,c){a=c.landValueMap.worldGet(a,b);debug&&(document.getElementById("queryLandValueRaw").innerHTML=a);b=0;150<=a?b=3:80<=a?b=2:30<=a&&(b=1);a=TXT.landValueStrings[b];document.getElementById("queryLandValue").innerHTML=a};Micro.QueryTool.prototype.classifyCrime=function(a,b,c){a=c.crimeRateMap.worldGet(a,b);debug&&(document.getElementById("queryCrimeRaw").innerHTML=a);a=a>>6&3;document.getElementById("queryCrime").innerHTML=TXT.crimeStrings[a]};
Micro.QueryTool.prototype.classifyPollution=function(a,b,c){a=c.pollutionDensityMap.worldGet(a,b);debug&&(document.getElementById("queryPollutionRaw").innerHTML=a);a=a>>6&3;document.getElementById("queryPollution").innerHTML=TXT.pollutionStrings[a]};Micro.QueryTool.prototype.classifyRateOfGrowth=function(a,b,c){a=c.rateOfGrowthMap.worldGet(a,b);debug&&(document.getElementById("queryRateRaw").innerHTML=a);a=a>>6&3;document.getElementById("queryRate").innerHTML=TXT.rateStrings[a]};
Micro.QueryTool.prototype.classifyDebug=function(a,b,c){debug&&(document.getElementById("queryFireStationRaw").innerHTML=c.fireStationMap.worldGet(a,b),document.getElementById("queryFireStationEffectRaw").innerHTML=c.fireStationEffectMap.worldGet(a,b),document.getElementById("queryPoliceStationRaw").innerHTML=c.policeStationMap.worldGet(a,b),document.getElementById("queryPoliceStationEffectRaw").innerHTML=c.policeStationEffectMap.worldGet(a,b),document.getElementById("queryTerrainDensityRaw").innerHTML=
c.terrainDensityMap.worldGet(a,b),document.getElementById("queryTrafficDensityRaw").innerHTML=c.trafficDensityMap.worldGet(a,b),document.getElementById("queryComRateRaw").innerHTML=c.comRateMap.worldGet(a,b))};
...
2;a++)if(this.map.getTileValue(a,this.map.height-1)===Tile.CHANNEL){this.makeShipHere(a,this.map.height-1);return}if(Random.getChance(3))for(a=1;a<this.map.height-2;a++)if(this.map.getTileValue(this.map.width-1,a)===Tile.CHANNEL){this.makeShipHere(this.map.width-1,a);break}},getBoatDistance:function(a,b){for(var c=99999,d=Micro.worldToPix(a)+8,e=Micro.worldToPix(b)+8,f,g=0,h=this.spriteList.length;g<h;g++)f=this.spriteList[g],f.type===Micro.SPRITE_SHIP&&0!==f.frame&&(f=Micro.absoluteValue(f.x-d)+
Micro.absoluteValue(f.y-e),c=Math.min(c,f));return c},makeShipHere:function(a,b){this.makeSprite(Micro.SPRITE_SHIP,Micro.worldToPix(a),Micro.worldToPix(b))},generateCopter:function(a,b){null===this.getSprite(Micro.SPRITE_HELICOPTER)&&this.makeSprite(Micro.SPRITE_HELICOPTER,Micro.worldToPix(a),Micro.worldToPix(b))},makeMonsterAt:function(a,b,c){this.makeSprite(Micro.SPRITE_MONSTER,Micro.worldToPix(b),Micro.worldToPix(c));a.sendMessage(Messages.MONSTER_SIGHTED,{x:b,y:c})},makeMonster:function(a){var b=
this.getSprite(Micro.SPRITE_MONSTER);null!==b&&(b.soundCount=1,b.count=1E3,b.destX=Micro.worldToPix(this.map.pollutionMaxX),b.destY=Micro.worldToPix(this.map.pollutionMaxY));for(var c=b=0;300>c;c++){var d=Random.getRandom(this.map.width-20)+10,e=Random.getRandom(this.map.height-10)+5;if(this.map.getTile(d,e).getValue()===Tile.RIVER){this.makeMonsterAt(a,d,e);b=1;break}}0===b&&this.makeMonsterAt(a,60,50)},pruneDeadSprites:function(a){this.spriteList=this.spriteList.filter(function(a){return 0!==a.frame})}};
var constructors={};constructors[Micro.SPRITE_TRAIN]=Micro.TrainSprite;constructors[Micro.SPRITE_SHIP]=Micro.BoatSprite;constructors[Micro.SPRITE_MONSTER]=Micro.MonsterSprite;constructors[Micro.SPRITE_HELICOPTER]=Micro.CopterSprite;constructors[Micro.SPRITE_AIRPLANE]=Micro.AirplaneSprite;constructors[Micro.SPRITE_TORNADO]=Micro.TornadoSprite;constructors[Micro.SPRITE_EXPLOSION]=Micro.ExplosionSprite;Micro.InfoBar=function(){return{setClass:function(a){document.getElementById("cclass").innerHTML=a},setDate:function(a,b){document.getElementById("date").innerHTML=[TXT.months[a],b].join(" ")},setFunds:function(a){document.getElementById("funds").innerHTML=a},setPopulation:function(a){document.getElementById("population").innerHTML=a},setScore:function(a){document.getElementById("score").innerHTML=a}}};var InfoBar=new Micro.InfoBar;Micro.RCI=function(a,b){var c=Error("Invalid parameter");if(1>arguments.length)throw c;void 0===b&&(b=a,a=Micro.RCI_DEFAULT_ID);if("string"===typeof b&&(c=b,b=document.getElementById("RCIContainer"),null===b))throw Error("Node "+c+" not found");this._padding=3;this._buckets=10;this._rectSize=5;this._scale=Math.floor(2E3/this._buckets);this._canvasWidth=9*this._rectSize;this._canvasHeight=(2*this._buckets+3*this._padding)*this._rectSize;this._canvas=document.createElement("canvas");this._canvas.id=
a;b.firstChild&&b.removeChild(b.firstChild);b.appendChild(this._canvas)};
Micro.RCI.prototype={constructor:Micro.RCI,_clear:function(a){a.clearRect(0,0,this._canvas.width,this._canvas.height)},_drawRect:function(a){var b=this._padding*this._rectSize,c=(this._buckets+this._padding)*this._rectSize,d=7*this._padding*this._rectSize,e=this._padding*this._rectSize;a.fillStyle="rgba(192, 192, 192,0.2)";a.fillRect(b,c,d,e)},_drawValue:function(a,b,c){1<b&&(c=Math.floor(2E3/1500*c));var d=Math.floor(Math.abs(c)/this._scale);c=0<=c?this._buckets+this._padding-d:this._buckets+2*this._padding;
var e=2*this._padding+2*b*this._padding;a.fillStyle=["rgb(0,255,0)","rgb(0, 0, 139)","rgb(255, 255, 0)"][b];a.fillRect(e*this._rectSize,c*this._rectSize,this._padding*this._rectSize,d*this._rectSize)},_drawLabel:function(a,b){var c=2*this._padding+2*b*this._padding+Math.floor(this._padding/2);a.font="normal xx-small sans-serif";a.fillStyle="rgb(0, 0, 0)";a.textBaseline="bottom";a.fillText(["R","C","I"][b],c*this._rectSize,(this._buckets+2*this._padding)*this._rectSize)},update:function(a,b,c){var d=
this._canvas.getContext("2d");this._clear(d);this._drawRect(d);a=[a,b,c];for(b=0;3>b;b++)this._drawValue(d,b,a[b]),this._drawLabel(d,b)}};Micro.DisasterWindow=function(a,b){this._opacityLayer=a;this._disasterWindowID=b;this._requestedDisaster=Micro.DISASTER_NONE;var c=this;document.getElementById("disasterCancel").addEventListener("click",function(a){c.cancel(a)},!1);document.getElementById("disasterForm").addEventListener("submit",function(a){c.submit(a)},!1)};
Micro.DisasterWindow.prototype={constructor:Micro.DisasterWindow,_toggleDisplay:function(){var a=document.getElementById(this._opacityLayer),b=document.getElementById(this._disasterWindowID);a.style.display="block"!==a.style.display?"block":"none";b.style.display="block"!==b.style.display?"block":"none"},_registerButtonListeners:function(){},open:function(a){this._callback=a;this._toggleDisplay()},cancel:function(a){a.preventDefault();this._toggleDisplay();this._callback(Micro.DISASTER_NONE)},submit:function(a){a.preventDefault();
a=document.getElementById("disasterSelect").value;console.log(a);this._toggleDisplay();this._callback(a)}};Micro.EvaluationWindow=function(a,b){this._opacityLayer=a;this._evaluationWindowID=b;var c=this;document.getElementById("evalForm").addEventListener("submit",function(a){c.submit(a)},!1);document.getElementById("evalOK").addEventListener("click",function(a){c.submit(a)},!1)};
Micro.EvaluationWindow.prototype={constructor:Micro.EvaluationWindow,_toggleDisplay:function(){var a=document.getElementById(this._opacityLayer),b=document.getElementById(this._evaluationWindowID);a.style.display="block"!==a.style.display?"block":"none";b.style.display="block"!==b.style.display?"block":"none"},_populateWindow:function(a){document.getElementById("evalYes").innerHTML=a.cityYes;document.getElementById("evalNo").innerHTML=100-a.cityYes;for(var b=0;4>b;b++){var c=a.getProblemNumber(b),
d="";-1!==c&&(d=Text.problems[c]);document.getElementById("evalProb"+(b+1)).innerHTML=d}document.getElementById("evalPopulation").innerHTML=a.cityPop;document.getElementById("evalMigration").innerHTML=a.cityPopDelta;document.getElementById("evalValue").innerHTML=a.cityAssessedValue;document.getElementById("evalLevel").innerHTML=TXT.gameLevel[a.gameLevel];document.getElementById("evalClass").innerHTML=TXT.cityClass[a.cityClass];document.getElementById("evalScore").innerHTML=a.cityScore;document.getElementById("evalScoreDelta").innerHTML=
a.cityScoreDelta},open:function(a,b){this._callback=a;this._populateWindow(b);this._toggleDisplay()},submit:function(a){a.preventDefault();this._callback();this._toggleDisplay()}};Micro.QueryWindow=function(a,b){this._opacityLayer=a;this._queryWindowID=b;this.debug=this._debugToggled=!1;var c=this;document.getElementById("queryForm").addEventListener("submit",function(a){c.submit(a)},!1);document.getElementById("queryOK").addEventListener("click",function(a){c.submit(a)},!1)};
Micro.QueryWindow.prototype={constructor:Micro.QueryWindow,_toggleDisplay:function(){var a=document.getElementById(this._opacityLayer),b=document.getElementById(this._queryWindowID);a.style.display="block"!==a.style.display?"block":"none";b.style.display="block"!==b.style.display?"block":"none";this.debug&&!this.debugToggled&&(this.debugToggled=!0)},open:function(a){this._callback=a;this._toggleDisplay()},submit:function(a){a.preventDefault();this._callback();this._toggleDisplay()}};Micro.BudgetWindow=function(a,b){this._opacityLayer=a;this._budgetWindowID=b;this.dataKeys=["roadFund","fireFund","policeFund"];this.spendKeys=["roadRate","fireRate","policeRate"];var c=this;document.getElementById("budgetReset").addEventListener("click",function(a){c.resetItems(a)},!1);document.getElementById("budgetCancel").addEventListener("click",function(a){c.cancel(a)},!1);document.getElementById("budgetForm").addEventListener("submit",function(a){c.submit(a)},!1)};
Micro.BudgetWindow.prototype={constructor:Micro.BudgetWindow,setSpendRangeText:function(a,b,c){a+="Label";b=[b,"% of $",c," = $",Math.floor(b/100*c)].join("");document.getElementById(a).innerHTML=b},onFundingUpdate:function(a,b){var c=document.getElementById(a),d=c.value-0,c=c.getAttribute("data-source");this.setSpendRangeText(a,d,this[c])},onTaxUpdate:function(a){document.getElementById("taxRateLabel").innerHTML=["Tax rate: ",document.getElementById("taxRate").value,"%"].join("")},resetItems:function(a){for(var b=
0;b<this.spendKeys.length;b++){var c=this["original"+this.spendKeys[b]];document.getElementById(this.spendKeys[b]).value=c;this.setSpendRangeText(this.spendKeys[b],c,this[this.dataKeys[b]])}document.getElementById("taxRate").value=this.originaltaxRate;this.onTaxUpdate();a.preventDefault()},cancel:function(a){a.preventDefault();this._callback(!0,null);this._toggleDisplay()},submit:function(a){a.preventDefault();a=document.getElementById("roadRate").value;var b=document.getElementById("fireRate").value,
c=document.getElementById("policeRate").value,d=document.getElementById("taxRate").value;this._callback(!1,{roadPercent:a,firePercent:b,policePercent:c,taxPercent:d});this._toggleDisplay()},_toggleDisplay:function(){var a=document.getElementById(this._opacityLayer),b=document.getElementById(this._budgetWindowID);a.style.display="block"!==a.style.display?"block":"none";b.style.display="block"!==b.style.display?"block":"none"},open:function(a,b){var c=this,d,e;this._callback=a;for(d=0;d<this.dataKeys.length;d++){if(void 0===
b[this.dataKeys[d]])throw Error("Missing budget data");this[this.dataKeys[d]]=b[this.dataKeys[d]]}for(d=0;d<this.spendKeys.length;d++){if(void 0===b[this.spendKeys[d]])throw Error("Missing budget data");e=this.spendKeys[d];this["original"+e]=b[e];this.setSpendRangeText(e,b[this.spendKeys[d]],this[this.dataKeys[d]]);e=document.getElementById(e);e.addEventListener("input",function(a){c.onFundingUpdate(c,c.spendKeys[d])},!1);e.value=b[this.spendKeys[d]]}if(void 0===b.taxRate)throw Error("Missing budget data");
this.originalTaxRate=b.taxRate;e=document.getElementById("taxRate");e.addEventListener("input",function(a){c.onTaxUpdate(a)},!1);e.value=b.taxRate;this.onTaxUpdate();e=b.totalFunds;if(void 0===e)throw Error("Missing budget data");var f=b.taxesCollected;if(void 0===f)throw Error("Missing budget data");var g=f-this.roadFund-this.fireFund-this.policeFund,h=e+g;document.getElementById("taxesCollected").innerHTML="$"+f;document.getElementById("cashFlow").innerHTML=(0>g?"-$":"$")+g;document.getElementById("previousFunds").innerHTML=
(0>e?"-$":"$")+e;document.getElementById("currentFunds").innerHTML="$"+h;this._toggleDisplay()}};Micro.MapScanner=function(a,b){this._map=a;this.mapHeight=this._map.height;this.mapWidth=this._map.width;this._actions=[];this.sim=b};
Micro.MapScanner.prototype={constructor:Micro.MapScanner,addAction:function(a,b){this._actions.push({criterion:a,action:b})},mapScan:function(a,b,c){var d,e,f,g;for(c=this.mapHeight;c--;)for(d=a;d<b;d++)if(e=d+c*this.mapWidth,f=this._map.data[e]||new Micro.Tile,g=f.getValue(),!(g<Tile.FLOOD))for(f.isConductive()&&this.sim.powerManager.setTilePower(d,c),f.isZone()&&(this.sim.repairManager.checkTile(d,c,this.sim._cityTime),f.isPowered()?this.sim.census.poweredZoneCount+=1:this.sim.census.unpoweredZoneCount+=
1),e=this._actions.length;e--;){var h=this._actions[e],k=Micro.isCallable(h.criterion);if(k&&h.criterion.call(null,f)){h.action.call(null,this._map,d,c,null);break}else if(!k&&h.criterion===g){h.action.call(null,this._map,d,c,null);break}}}};Micro.PowerManager=function(a,b){this.sim=b;this._map=a;this._powerStack=[];this.powerGridMap=new Micro.BlockMap(this._map.width,this._map.height,1,0)};
...
coalPowerFound:function(a,b,c,d){this.sim.census.coalPowerPop+=1;this._powerStack.push(new a.Position(b,c));d=[-1,2,1,2];for(var e=[-1,-1,0,0],f=0;4>f;f++)a.addTileFlags(b+d[f],c+e[f],Tile.ANIMBIT)},nuclearPowerFound:function(a,b,c,d){d=[3E4,2E4,1E4];if(!this.sim.disasterManager.disastersEnabled||0!==Random.getRandom(d[this.sim.gameLevel]))for(this.sim.census.nuclearPowerPop+=1,this._powerStack.push(new a.Position(b,c)),d=0;4>d;d++)a.addTileFlags(b,c,Tile.ANIMBIT|Tile.CONDBIT|Tile.POWERBIT|Tile.BURNBIT)},
registerHandlers:function(a,b){a.addAction(Tile.POWERPLANT,this.coalPowerFound.bind(this));a.addAction(Tile.NUCLEAR,this.nuclearPowerFound.bind(this));b.addAction(Tile.POWERPLANT,7,4);b.addAction(Tile.NUCLEAR,7,4)}};Micro.RepairManager=function(a){this._map=a;this._actions=[]};
...
b;h<d;h++)if(!(0>a||a>=this._map.width||0>h||h>=this._map.height)){var k=this._map.getTile(a,h);if(k.isZone()&&!k.isPowered()&&this.shouldBlink)g.push({x:a,y:h,tileValue:Tile.LIGHTNINGBOLT});else if(k.isAnimated()){var k=k.getValue(),m=Tile.TILE_INVALID,l;this._lastPainted&&(l=this._lastPainted.getTile(a,h));f?m=l&&this.inSequence(k,l)?this._data[l]:this._data[k]:l&&this.inSequence(k,l)&&(m=l);m!==Tile.TILE_INVALID&&(g.push({x:a,y:h,tileValue:m}),e.setTile(a,h,m))}}this._lastPainted=e;return g},registerSingleAnimation:function(a){for(var b=
...
953,954,955,952]);this.registerSingleAnimation([832,833,834,835,836,837,838,839,832]);this.registerSingleAnimation([840,841,842,843,840]);this.registerSingleAnimation([844,845,846,847,848,849,850,851,844]);this.registerSingleAnimation([932,933,934,935,936,937,938,939,932]);this.registerSingleAnimation([940,941,942,943,944,945,946,947,940])}};Micro.GameCanvas=function(a,b,c,d){this._canvas=document.createElement("canvas");this._canvas.id=Micro.DEFAULT_ID;this._canvas.width=Micro.DEFAULT_WIDTH;this._canvas.height=Micro.DEFAULT_HEIGHT;this._moved=this._justConstructed=!1;this._pendingTileSet=null;b=document.getElementById("canvasContainer");b.appendChild(this._canvas);this.ready=!1};
Micro.GameCanvas.prototype={constructor:Micro.GameCanvas,init:function(a,b,c){var d=Error("Invalid parameter");if(3>arguments.length)throw d;if(!b.loaded)throw Error("TileSet not ready!");this._spriteSheet=c;this._tileSet=b;d=this._tileSet.tileWidth;this._map=a;this._animationManager=new Micro.AnimationManager(a);if(this._canvas.width<d||this._canvas.height<d)throw Error("Canvas too small!");this._calculateMaximaAndMinima();this.ready=!0;this.centreOn(Math.floor(this._map.width/2),Math.floor(this._map.height/
2));this._justConstructed=!0;this.paint(null,null)},_calculateMaximaAndMinima:function(){var a=this._tileSet.tileWidth;this.minX=0-Math.ceil(Math.floor(this._canvas.width/a)/2);this.maxX=this._map.width-1-Math.ceil(Math.floor(this._canvas.width/a)/2);this.minY=0-Math.ceil(Math.floor(this._canvas.height/a)/2);this.maxY=this._map.height-1-Math.ceil(Math.floor(this._canvas.height/a)/2);this._wholeTilesInViewX=Math.floor(this._canvas.width/a);this._wholeTilesInViewY=Math.floor(this._canvas.height/a);
this._totalTilesInViewX=Math.ceil(this._canvas.width/a);this._totalTilesInViewY=Math.ceil(this._canvas.height/a)},moveNorth:function(){if(!this.ready)throw Error("Not ready!");this._originY>this.minY&&(this._moved=!0,this._originY--)},moveEast:function(){if(!this.ready)throw Error("Not ready!");this._originX<this.maxX&&(this._moved=!0,this._originX++)},moveSouth:function(){if(!this.ready)throw Error("Not ready!");this._originY<this.maxY&&(this._moved=!0,this._originY++)},moveWest:function(){if(!this.ready)throw Error("Not ready!");
this._originX>this.minX&&(this._moved=!0,this._originX--)},moveTo:function(a,b){var c=Error("Invalid parameter");if(1>arguments.length)throw c;if(!this.ready)throw Error("Not ready!");if(a<this.minX||a>this.maxX||b<this.minY||b>this.maxY)throw Error("Coordinates out of bounds");this._originX=a;this._originY=b;this._moved=!0},centreOn:function(a,b){var c=Error("Invalid parameter");if(1>arguments.length)throw c;if(!this.ready)throw Error("Not ready!");void 0===b&&(b=a.y,a=a.x);this._originX=Math.floor(a)-
Math.ceil(this._wholeTilesInViewX/2);this._originY=Math.floor(b)-Math.ceil(this._wholeTilesInViewY/2);this._moved=!0},getTileOrigin:function(){var a=Error("Not ready!");if(!this.ready)throw a;return{x:this._originX,y:this._originY}},getMaxTile:function(){var a=Error("Not ready!");if(!this.ready)throw a;return{x:this._originX+this._totalTilesInViewX-1,y:this._originY+this._totalTilesInViewY-1}},canvasCoordinateToTileOffset:function(a,b){var c=Error("Invalid parameter");if(2>arguments.length)throw c;
if(!this.ready)throw Error("Not ready!");return{x:Math.floor(a/this._tileSet.tileWidth),y:Math.floor(b/this._tileSet.tileWidth)}},canvasCoordinateToTileCoordinate:function(a,b){var c=Error("Invalid parameter");if(2>arguments.length)throw c;if(!this.ready)throw Error("Not ready!");return a>=this._canvas.width||b>=this._canvas.height?null:{x:this._originX+Math.floor(a/this._tileSet.tileWidth),y:this._originY+Math.floor(b/this._tileSet.tileWidth)}},canvasCoordinateToPosition:function(a,b){var c=Error("Invalid parameter");
if(2>arguments.length)throw c;if(!this.ready)throw Error("Not ready!");if(a>=this._canvas.width||b>=this._canvas.height)return null;a=this._originX+Math.floor(a/this._tileSet.tileWidth);b=this._originY+Math.floor(b/this._tileSet.tileWidth);return 0>a||a>=this._map.width||0>b||b>=this._map.height?null:new this._map.Position(a,b)},positionToCanvasCoordinate:function(a){var b=Error("Invalid parameter");if(1>arguments.length)throw b;return this.tileToCanvasCoordinate(a)},tileToCanvasCoordinate:function(a,
b){var c=Error("Invalid parameter");if(1>arguments.length)throw c;if(!this.ready)throw Error("Not ready!");void 0===b&&(b=a.y,a=a.x);if(void 0===a||void 0===b||a<this.minX||b<this.minY||a>this.maxX+this._totalTilesInViewX-1||b>this.maxY+this._totalTilesInViewY-1)throw c;return a<this._originX||a>=this._originX+this._totalTilesInViewX||b<this._originY||b>=this._originY+this._totalTilesInViewY?null:{x:(a-this._originX)*this._tileSet.tileWidth,y:(b-this._originY)*this._tileSet.tileWidth}},changeTileSet:function(a){var b=
Error("Invalid parameter");if(1>arguments.length)throw b;if(!this.ready)throw Error("Not ready!");if(!a.loaded)throw Error("new tileset not loaded");if(this._pendingTileSet&&(this._pendingHeight||this._pendingWidth))throw Error("dimensions have changed");var b=a.tileWidth,c=null===this._pendingHeight?this._canvas.height:this._pendingHeight;if((null===this._pendingWidth?this._canvas.width:this._pendingWidth)<b||c<b)throw Error("canvas too small");this._pendingTileSet=a},takeScreenshot:function(a){var b=
Error("Invalid parameter");if(1>arguments.length)throw b;if(!this.ready)throw Error("Not ready!");if(a)return this._canvas.toDataURL();b=document.createElement("canvas");b.width=this._map.width*this._tileSet.tileWidth;b.height=this._map.height*this._tileSet.tileWidth;for(var c=0;c<this._map.width;c++)for(var d=0;d<this._map.height;d++)this._paintTile(this._map.getTileValue(c,d),c*this._tileSet.tileWidth,d*this._tileSet.tileWidth,b);return b.toDataURL()},shoogle:function(){},_paintTile:function(a,
b,c,d){d=d||this._canvas;a=this._tileSet[a];d.getContext("2d").drawImage(a,b,c)},_paintVoid:function(a,b,c,d,e){e=e||"black";var f=this._canvas.getContext("2d");f.fillStyle=e;f.fillRect(a,b,c,d)},_getDataForPainting:function(){var a=this._originX,b=this._originY,c=this._totalTilesInViewX,d=this._totalTilesInViewY;0>a&&(c+=a,a=0);0>b&&(d+=b,b=0);a+c>this._map.width&&(c=this._map.width-a);b+d>this._map.height&&(d=this._map.height-b);return{offsetX:a-this._originX,offsetY:b-this._originY,tileData:this._map.getTiles(a,
b,c,d)}},_fullRepaint:function(a){var b,c;this._canvas.getContext("2d").clearRect(0,0,this._canvas.width,this._canvas.height);0>this._originX&&this._paintVoid(0,0,this._tileSet.tileWidth*(0-this._originX),this._canvas.height);this._originX+this._totalTilesInViewX>this._map.width&&(b=this.tileToCanvasCoordinate(this._map.width,this._originY).x,c=this._canvas.width-b,this._paintVoid(b,0,c,this._canvas.height));0>this._originY&&this._paintVoid(0,0,this._canvas.width,this._tileSet.tileWidth*(0-this._originY));
this._originY+this._totalTilesInViewY>this._map.height&&(b=this.tileToCanvasCoordinate(this._originX,this._map.height).x,c=this._canvas.height-b,this._paintVoid(0,b,this._canvas.width,c));b=a.offsetX;c=a.offsetY;a=a.tileData;for(var d=0;d<a.length;d++)for(var e=a[d],f=0,g=e.length;f<g;f++)this._paintTile(e[f].getValue(),(f+b)*this._tileSet.tileWidth,(d+c)*this._tileSet.tileWidth)},_paintAnimatedTiles:function(a){var b=this._originX,c=this._originY;a=this._animationManager.getTiles(b,c,b+this._totalTilesInViewX+
1,c+this._totalTilesInViewY+1,a);for(var d=0,e=a.length;d<e;d++){var f=a[d];this._paintTile(f.tileValue,(f.x-b)*this._tileSet.tileWidth,(f.y-c)*this._tileSet.tileWidth)}},_processSprites:function(a){for(var b=this._canvas.getContext("2d"),c=0,d=a.length;c<d;c++){var e=a[c];b.drawImage(this._spriteSheet,48*(e.frame-1),48*(e.type-1),e.width,e.width,e.x+e.xOffset-16*this._originX,e.y+e.yOffset-16*this._originY,e.width,e.width)}},_processMouse:function(a){if(0!==a.width&&0!==a.height){var b=a.x,c=a.y,
d=a.width,e=a.height;a={colour:a.colour,outline:!0};2<d&&(b-=1);2<e&&(c-=1);0>this._originX+b&&0>=this._originX+b+d||0>this._originY+c&&0>=this._originY+c+e||this._originX+b>=this._map.width||this._originY+c>=this._map.height||Micro.MouseBox.draw(this._canvas,{x:b*this._tileSet.tileWidth,y:c*this._tileSet.tileWidth},d*this._tileSet.tileWidth,e*this._tileSet.tileWidth,a)}},paint:function(a,b,c){var d=Error("Invalid parameter");if(2>arguments.length)throw d;if(!this.ready)throw Error("Not ready!");
var e=!1;null!==this._pendingTileSet&&(this._tileSet=this._pendingTileSet,this._pendingTileSet=null,e=!0);e&&this._calculateMaximaAndMinima();d=!0;if(this._justConstructed||this._moved||e)this._moved=this._justConstructed=!1,d=!0;e=this._getDataForPainting();d&&this._fullRepaint(e);this._paintAnimatedTiles(c);a&&this._processMouse(a);b&&this._processSprites(b)}};Micro.copyFrom=function(a,b){for(var c=function(a){return b(a)},d=a.data.length;d--;)this.data[d]=a.data[d].map(c)};Micro.makeArrayOf=function(a,b){for(var c=Array(a),d=a;d--;)c[d]=b;return c};
Micro.BlockMap=function(a,b,c,d){var e,f,g=function(a){return a},h=Error("Invalid parameters");if(3>arguments.length){if(!(a instanceof Micro.BlockMap)||2===arguments.length&&"function"!==typeof b)throw h;e=a;f=void 0===b?g:b}void 0!==e&&(a=e.width,b=e.height,c=e.blockSize,d=e.defaultValue);Object.defineProperties(this,{mapWidth:Micro.makeConstantDescriptor(a),mapHeight:Micro.makeConstantDescriptor(b),width:Micro.makeConstantDescriptor(Math.floor((a+1)/c)),height:Micro.makeConstantDescriptor(Math.floor((b+
...
Micro.BlockMap.prototype={constructor:Micro.BlockMap,clear:function(){for(var a=Math.floor(this.mapHeight/this.blockSize)+1,b=Math.floor(this.mapWidth/this.blockSize)+1,c=0;c<a;c++)this.data[c]=Micro.makeArrayOf(b,this.defaultValue)},get:function(a,b){return this.data[b][a]},set:function(a,b,c){this.data[b][a]=c},toBlock:function(a){return Math.floor(a/this.blockSize)},worldGet:function(a,b){return this.get(this.toBlock(a),this.toBlock(b))},worldSet:function(a,b,c){this.set(this.toBlock(a),this.toBlock(b),
c)}};var Residential,Commercial,Industrial,Transport,Road,EmergencyServices,MiscTiles,Stadia;
Micro.Simulation=function(a,b,c){if(b!==Micro.LEVEL_EASY&&b!==Micro.LEVEL_MED&&b!==Micro.LEVEL_HARD)throw Error("Invalid level!");if(c!==Micro.SPEED_PAUSED&&c!==Micro.SPEED_SLOW&&c!==Micro.SPEED_MED&&c!==Micro.SPEED_FAST)throw Error("Invalid speed!");this.map=a;this.gameLevel=b;this.div=this.map.width/8;this.speed=c;this.simCycle=this.phaseCycle=this.speedCycle=0;this.doInitialEval=!0;this.cityTime=50;this.cityPopLast=0;this.messageLast=Messages.VILLAGE_REACHED;this.startingYear=1900;this.indValveLast=
this.comValveLast=this.resValveLast=0;this._cityMonthLast=this._cityYearLast=-1;this.evaluation=new Micro.Evaluation(this.gameLevel,this);this.valves=new Micro.Valves;this.budget=new Micro.Budget;this.census=new Micro.Census;this.messageManager=new Micro.MessageManager;this.powerManager=new Micro.PowerManager(this.map,this);this.spriteManager=new Micro.SpriteManager(this.map,this);this.mapScanner=new Micro.MapScanner(this.map,this);this.repairManager=new Micro.RepairManager(this.map);this.traffic=
new Micro.Traffic(this.map,this.spriteManager);this.disasterManager=new Micro.DisasterManager(this.map,this.spriteManager,this.gameLevel);this.blockMaps={comRateMap:new Micro.BlockMap(this.map.width,this.map.height,8,0),crimeRateMap:new Micro.BlockMap(this.map.width,this.map.height,2,0),fireStationMap:new Micro.BlockMap(this.map.width,this.map.height,8,0),fireStationEffectMap:new Micro.BlockMap(this.map.width,this.map.height,8,0),landValueMap:new Micro.BlockMap(this.map.width,this.map.height,2,0),
policeStationMap:new Micro.BlockMap(this.map.width,this.map.height,8,0),policeStationEffectMap:new Micro.BlockMap(this.map.width,this.map.height,8,0),pollutionDensityMap:new Micro.BlockMap(this.map.width,this.map.height,2,0),populationDensityMap:new Micro.BlockMap(this.map.width,this.map.height,2,0),rateOfGrowthMap:new Micro.BlockMap(this.map.width,this.map.height,8,0),tempMap1:new Micro.BlockMap(this.map.width,this.map.height,2,0),tempMap2:new Micro.BlockMap(this.map.width,this.map.height,2,0),tempMap3:new Micro.BlockMap(this.map.width,
this.map.height,4,0),terrainDensityMap:new Micro.BlockMap(this.map.width,this.map.height,4,0),trafficDensityMap:new Micro.BlockMap(this.map.width,this.map.height,2,0)};this.init()};
Micro.Simulation.prototype={constructor:Micro.Simulation,setSpeed:function(a){if(a!==Micro.SPEED_PAUSED&&a!==Micro.SPEED_SLOW&&a!==Micro.SPEED_MED&&a!==Micro.SPEED_FAST)throw Error("Invalid speed!");this.speed=a},isPaused:function(){return this.speed===Micro.SPEED_PAUSED},simFrame:function(){this.budget.awaitingValues||0===this.speed||1===this.speed&&0!==this.speedCycle%5||2===this.speed&&0!==this.speedCycle%3||(this.messageManager.clear(),this.simulate())},clearCensus:function(){this.census.clearCensus();
this.powerManager.clearPowerStack();this.blockMaps.fireStationMap.clear();this.blockMaps.policeStationMap.clear()},init:function(){Residential=new Micro.Residential(this);Commercial=new Micro.Commercial(this);Industrial=new Micro.Industrial(this);Road=new Micro.Road(this);Transport=new Micro.Transport(this);EmergencyServices=new Micro.EmergencyServices(this);MiscTiles=new Micro.MiscTiles(this);Stadia=new Micro.Stadia(this);Commercial.registerHandlers(this.mapScanner,this.repairManager);EmergencyServices.registerHandlers(this.mapScanner,
this.repairManager);Industrial.registerHandlers(this.mapScanner,this.repairManager);MiscTiles.registerHandlers(this.mapScanner,this.repairManager);this.powerManager.registerHandlers(this.mapScanner,this.repairManager);Road.registerHandlers(this.mapScanner,this.repairManager);Residential.registerHandlers(this.mapScanner,this.repairManager);Stadia.registerHandlers(this.mapScanner,this.repairManager);Transport.registerHandlers(this.mapScanner,this.repairManager);this.budget.setFunds(2E4);this.evaluation.evalInit();
this.valves.setValves(this.gameLevel,this.census,this.budget);this.clearCensus();this.mapScanner.mapScan(0,this.map.width,null);this.powerManager.doPowerScan(this.census,this.messageManager);Micro.pollutionTerrainLandValueScan(this.map,this.census,this.blockMaps);Micro.crimeScan(this.census,this.blockMaps);Micro.populationDensityScan(this.map,this.blockMaps);Micro.fireAnalysis(this.blockMaps);this.census.totalPop=1},simulate:function(){this.phaseCycle&=15;var a=this.speed-1;switch(this.phaseCycle){case 0:1023<
++this.simCycle&&(this.simCycle=0);this.doInitialEval&&(this.doInitialEval=!1,this.evaluation.cityEvaluation());this.cityTime++;0===(this.simCycle&1)&&this.valves.setValves(this.gameLevel,this.census,this.budget);this.clearCensus();break;case 1:case 2:case 3:case 4:case 5:case 6:case 7:case 8:this.mapScanner.mapScan((this.phaseCycle-1)*this.div,this.phaseCycle*this.div,null);break;case 9:0===this.cityTime%Micro.CENSUS_FREQUENCY_10&&this.census.take10Census(this.budget);0===this.cityTime%Micro.CENSUS_FREQUENCY_120&&
this.census.take120Census(this.budget);0===this.cityTime%Micro.TAX_FREQUENCY&&(this.budget.collectTax(this.gameLevel,this.census,this.messageManager),this.evaluation.cityEvaluation());break;case 10:0===this.simCycle%5&&Micro.decRateOfGrowthMap(this.blockMaps);Micro.decTrafficMap(this.blockMaps);this.sendMessages();break;case 11:0===this.simCycle%Micro.speedPowerScan[a]&&this.powerManager.doPowerScan(this.census,this.messageManager);break;case 12:0===this.simCycle%Micro.speedPollutionTerrainLandValueScan[a]&&
Micro.pollutionTerrainLandValueScan(this.map,this.census,this.blockMaps);break;case 13:0===this.simCycle%Micro.speedCrimeScan[a]&&Micro.crimeScan(this.census,this.blockMaps);break;case 14:0===this.simCycle%Micro.speedPopulationDensityScan[a]&&Micro.populationDensityScan(this.map,this.blockMaps);break;case 15:0===this.simCycle%Micro.speedFireAnalysis[a]&&Micro.fireAnalysis(this.blockMaps),this.disasterManager.doDisasters(this.census,this.messageManager)}this.phaseCycle=this.phaseCycle+1&15},sendMessages:function(){this.checkGrowth();
var a=this.census.resZonePop+this.census.comZonePop+this.census.indZonePop,b=this.census.nuclearPowerPop+this.census.coalPowerPop;switch(this.cityTime&63){case 1:Math.floor(a/4)>=this.census.resZonePop&&this.messageManager.sendMessage(Messages.NEED_MORE_RESIDENTIAL);break;case 5:Math.floor(a/8)>=this.census.comZonePop&&this.messageManager.sendMessage(Messages.NEED_MORE_COMMERCIAL);break;case 10:Math.floor(a/8)>=this.census.indZonePop&&this.messageManager.sendMessage(Messages.NEED_MORE_INDUSTRIAL);
break;case 14:10<a&&2*a>this.census.roadTotal&&this.messageManager.sendMessage(Messages.NEED_MORE_ROADS);break;case 18:50<a&&a>this.census.railTotal&&this.messageManager.sendMessage(Messages.NEED_MORE_RAILS);break;case 22:10<a&&0==b&&this.messageManager.sendMessage(Messages.NEED_ELECTRICITY);break;case 26:500<this.census.resPop&&0===this.census.stadiumPop?(this.messageManager.sendMessage(Messages.NEED_STADIUM),this.valves.resCap=!0):this.valves.resCap=!1;break;case 28:70<this.census.indPop&&0===this.census.seaportPop?
(this.messageManager.sendMessage(Messages.NEED_SEAPORT),this.valves.indCap=!0):this.valves.indCap=!1;break;case 30:100<this.census.comPop&&0===this.census.airportPop?(this.messageManager.sendMessage(Messages._NEED_AIRPORT),this.valves.comCap=!0):this.valves.comCap=!1;break;case 32:a=this.census.unpoweredZoneCount+this.census.poweredZoneCount;0<a&&0.7>this.census.poweredZoneCount/a&&this.messageManager.sendMessage(Messages.BLACKOUTS_REPORTED);break;case 35:60<this.census.pollutionAverage&&this.messageManager.sendMessage(Messages.HIGH_POLLUTION);
break;case 42:100<this.census.crimeAverage&&this.messageManager.sendMessage(Messages.HIGH_CRIME);break;case 45:60<this.census.totalPop&&0===this.census.fireStationPop&&this.messageManager.sendMessage(Messages.NEED_FIRE_STATION);break;case 48:60<this.census.totalPop&&0===this.census.policeStationPop&&this.messageManager.sendMessage(Messages.NEED_POLICE_STATION);break;case 51:12<this.budget.cityTax&&this.messageManager.sendMessage(Messages.TAX_TOO_HIGH);break;case 54:this.budget.roadEffect<Math.floor(5*
this.budget.MAX_ROAD_EFFECT/8)&&30<this.census.roadTotal&&this.messageManager.sendMessage(Messages.ROAD_NEEDS_FUNDING);break;case 57:this.budget.fireEffect<Math.floor(7*this.budget.MAX_FIRE_STATION_EFFECT/10)&&20<this.census.totalPop&&this.messageManager.sendMessage(Messages.FIRE_STATION_NEEDS_FUNDING);break;case 60:this.budget.policeEffect<Math.floor(7*this.budget.MAX_POLICE_STATION_EFFECT/10)&&20<this.census.totalPop&&this.messageManager.sendMessage(Messages.POLICE_NEEDS_FUNDING);break;case 63:60<
this.census.trafficAverage&&this.messageManager.sendMessage(Messages.TRAFFIC_JAMS,-1,-1,!0)}},checkGrowth:function(){if(0===(this.cityTime&3)){var a="",b=this.evaluation.getPopulation(this.census);if(0<this.cityPopLast){var c=this.evaluation.getCityClass(this.cityPopLast),d=this.evaluation.getCityClass(b);if(c!==d)switch(d){case Micro.CC_TOWN:a=Messages.REACHED_TOWN;break;case Micro.CC_CITY:a=Messages.REACHED_CITY;break;case Micro.CC_CAPITAL:a=Messages.REACHED_CAPITAL;break;case Micro.CC_METROPOLIS:a=
Messages.REACHED_METROPOLIS;break;case Micro.CC_MEGALOPOLIS:a=Messages.REACHED_MEGALOPOLIS}}""!==a&&a!==this.messageLast&&(this.messageManager.sendMessage(a),this.messageLast=a);this.cityPopLast=b}},updateFrontEnd:function(){this.valves.changed&&(this._resLast=this.valves.resValve,this._comLast=this.valves.comValve,this._indLast=this.valves.indValve,this.messageManager.sendMessage(Messages.VALVES_UPDATED,{residential:this.valves.resValve,commercial:this.valves.comValve,industrial:this.valves.indValve}),
this.valves.changed=!1);this.updateTime();this.evaluation.changed&&(this.messageManager.sendMessage(Messages.EVAL_UPDATED,{classification:this.evaluation.cityClass,population:this.evaluation.cityPop,score:this.evaluation.cityScore}),this.evaluation.changed=!1)},setYear:function(a){a<this.startingYear&&(a=this.startingYear);a=a-this.startingYear-this.cityTime/48;this.cityTime+=48*a;this.updateTime()},updateTime:function(){var a=Math.floor(this.cityTime/48)+this.startingYear,b=Math.floor(this.cityTime%
48)>>2;if(1E6<=a)this.setYear(this.startingYear);else if(this._cityYearLast!==a||this._cityMonthLast!==b)this._cityYearLast=a,this._cityMonthLast=b,this.messageManager.sendMessage(Messages.DATE_UPDATED,{month:b,year:a})}};Micro.Game=function(a,b,c,d){this.debug=document.getElementById("debug");d=d||0;this.gameMap=a;this.tileSet=b||null;this.notification=new Micro.Notification;this.simulation=new Micro.Simulation(this.gameMap,d,3);this.rci=new Micro.RCI("RCIContainer");this.budgetWindow=new Micro.BudgetWindow("opaque","budget");this.queryWindow=new Micro.QueryWindow("opaque","queryWindow");this.evalWindow=new Micro.EvaluationWindow("opaque","evalWindow");this.disasterWindow=new Micro.DisasterWindow("opaque","disasterWindow");
this.gameCanvas=null;null!==this.tileSet&&(this.gameCanvas=new Micro.GameCanvas("canvasContainer"),this.gameCanvas.init(this.gameMap,this.tileSet,c));this.inputStatus=new Micro.InputStatus(this.gameMap);this.lastCoord=this.sprites=this.mouse=null;this.revealControls();this.isPaused=this.simNeedsBudget=this.evalShowing=this.queryShowing=this.budgetShowing=!1;this.timer=setInterval(this.update,1E3/30,this)};
Micro.Game.prototype={constructor:Micro.Game,revealControls:function(){for(var a=document.getElementsByClassName("initialHidden"),b=0;b<a.length;b++)a[b].className=a[b].className.replace("initialHidden",""),a[b]&&"buttons"==a[b].id&&(a[b].style.display="table");document.getElementById("buttonsInfos").style.display="block";document.getElementById("miscControls").style.display="block";this.notification.news(TXT.neutralMessages[Messages.WELCOME]);this.rci.update(0,0,0)},handleDisasterClosed:function(a){this.disasterShowing=
!1;if(a!==Micro.DISASTER_NONE){var b=new Micro.MessageManager;switch(a){case Micro.DISASTER_MONSTER:this.simulation.spriteManager.makeMonster(b);break;case Micro.DISASTER_FIRE:this.simulation.disasterManager.makeFire(b);break;case Micro.DISASTER_FLOOD:this.simulation.disasterManager.makeFlood(b);break;case Micro.DISASTER_CRASH:this.simulation.disasterManager.makeCrash(b);break;case Micro.DISASTER_MELTDOWN:this.simulation.disasterManager.makeMeltdown(b);break;case Micro.DISASTER_TORNADO:this.simulation.spriteManager.makeTornado(b)}this.processMessages(b.getMessages())}},
handleEvalClosed:function(){this.evalShowing=!1},handleQueryClosed:function(){this.queryShowing=!1},handleBudgetClosed:function(a,b){this.budgetShowing=!1;a||(this.simulation.budget.roadPercent=b.roadPercent/100,this.simulation.budget.firePercent=b.firePercent/100,this.simulation.budget.policePercent=b.policePercent/100,this.simulation.budget.setTax(b.taxPercent),this.simNeededBudget?(this.simulation.budget.doBudget(new Micro.MessageManager),this.simNeededBudget=!1):this.simulation.budget.updateFundEffects())},
handleDisasterRequest:function(){this.disasterShowing=!0;this.disasterWindow.open(this.handleDisasterClosed.bind(this));this.inputStatus.disasterHandled()},handleEvalRequest:function(){this.evalShowing=!0;this.evalWindow.open(this.handleEvalClosed.bind(this),this.simulation.evaluation);this.inputStatus.evalHandled()},handleBudgetRequest:function(){this.budgetShowing=!0;var a={roadFund:this.simulation.budget.roadFund,roadRate:Math.floor(100*this.simulation.budget.roadPercent),fireFund:this.simulation.budget.fireFund,
fireRate:Math.floor(100*this.simulation.budget.firePercent),policeFund:this.simulation.budget.policeFund,policeRate:Math.floor(100*this.simulation.budget.policePercent),taxRate:this.simulation.budget.cityTax,totalFunds:this.simulation.budget.totalFunds,taxesCollected:this.simulation.budget.taxFund};this.budgetWindow.open(this.handleBudgetClosed.bind(this),a);this.inputStatus.budgetHandled()},handleTool:function(a,b){var c=this.gameCanvas.canvasCoordinateToTileCoordinate(a,b);if(null!==c){var d=this.inputStatus.currentTool,
e=this.simulation.budget,f=new Micro.MessageManager;d.doTool(c.x,c.y,f,this.simulation.blockMaps);d.modifyIfEnoughFunding(e,f);switch(d.result){case d.TOOLRESULT_NEEDS_BULLDOZE:document.getElementById("toolOutput").innerHTML=TXT.toolMessages.needsDoze;break;case d.TOOLRESULT_NO_MONEY:document.getElementById("toolOutput").innerHTML=TXT.toolMessages.noMoney;break;default:document.getElementById("toolOutput").innerHTML="&nbsp;"}this.processMessages(f.getMessages())}this.inputStatus.clickHandled()},handleSpeedChange:function(){(this.isPaused=
!this.isPaused)?this.simulation.setSpeed(Micro.SPEED_PAUSED):this.simulation.setSpeed(Micro.SPEED_SLOW);this.inputStatus.speedChangeHandled()},handleInput:function(){this.inputStatus.budgetRequested?this.handleBudgetRequest():this.inputStatus.evalRequested?this.handleEvalRequest():this.inputStatus.disasterRequested?this.handleDisasterRequest():this.inputStatus.speedChangeRequested?this.handleSpeedChange():(this.inputStatus.left?this.gameCanvas.moveWest():this.inputStatus.up?this.gameCanvas.moveNorth():
this.inputStatus.right?this.gameCanvas.moveEast():this.inputStatus.down&&this.gameCanvas.moveSouth(),null!==this.inputStatus.currentTool&&-1!==this.inputStatus.clickX&&-1!==this.inputStatus.clickY&&this.handleTool(this.inputStatus.clickX,this.inputStatus.clickY))},processMessages:function(a){for(var b=!1,c=0,d=a.length;c<d;c++){var e=a[c];switch(e.message){case Messages.BUDGET_NEEDED:this.simNeededBudget=!0;this.handleBudgetRequest();break;case Messages.QUERY_WINDOW_NEEDED:this.queryWindow.open(this.handleQueryClosed.bind(this));
break;case Messages.DATE_UPDATED:InfoBar.setDate(e.data.month,e.data.year);break;case Messages.EVAL_UPDATED:InfoBar.setClass(TXT.cityClass[e.data.classification]);InfoBar.setScore(e.data.score);InfoBar.setPopulation(e.data.population);break;case Messages.FUNDS_CHANGED:InfoBar.setFunds(e.data);break;case Messages.VALVES_UPDATED:this.rci.update(e.data.residential,e.data.commercial,e.data.industrial);break;default:if(!b&&void 0!==TXT.goodMessages[e.message]){b=!0;this.notification.goodNews(TXT.goodMessages[e.message]);
break}if(!b&&void 0!==TXT.badMessages[e.message]){b=!0;this.notification.badNews(TXT.badMessages[e.message]);break}b||void 0===TXT.neutralMessages[e.message]||(b=!0,this.notification.news(TXT.neutralMessages[e.message]))}}},calculateMouseForPaint:function(){var a=null;if(-1!==this.inputStatus.mouseX&&0<this.inputStatus.toolWidth){var b=this.gameCanvas.canvasCoordinateToTileOffset(this.inputStatus.mouseX,this.inputStatus.mouseY);null!==b&&(a={},a.x=b.x,a.y=b.y,a.width=this.inputStatus.toolWidth-0,
a.height=this.inputStatus.toolWidth-0,a.colour=this.inputStatus.toolColour||"yellow")}return a},calculateSpritesForPaint:function(){var a=this.gameCanvas.getTileOrigin(),b=this.gameCanvas.getMaxTile(),a=this.simulation.spriteManager.getSpritesInView(a.x,a.y,b.x+1,b.y+1);return 0===a.length?null:a},update:function(a){var b=new Date;a.handleInput();a.mouse=a.calculateMouseForPaint();var c=new Date;a.isPaused||(a.simulation.simFrame(),a.simulation.updateFrontEnd(),a.processMessages(a.simulation.messageManager.getMessages()),
a.simulation.spriteManager.moveObjects());var d=new Date;a.sprite=a.calculateSpritesForPaint();var e=new Date;a.gameCanvas.paint(a.mouse,a.sprite,a.isPaused);var f=new Date;a.debug.innerHTML="input:"+(c-b)+" sim:"+(d-c)+" sprite:"+(e-d)+" paint:"+(f-e)+" total:"+(f-b)+" "+a.isPaused}};
