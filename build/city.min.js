...
Micro.rotate10Arrays=function(){for(var a=0;a<Micro.arrs.length;a++){var b=Micro.arrs[a]+"Hist10";this[b].pop();this[b].unshift(0)}};Micro.rotate120Arrays=function(){for(var a=0;a<Micro.arrs.length;a++){var b=Micro.arrs[a]+"Hist120";this[b].pop();this[b].unshift(0)}};Micro.isCallable=function(a){return"function"===typeof a};Micro.LEVEL_EASY=0;Micro.LEVEL_MED=1;Micro.LEVEL_HARD=2;Micro.SPEED_PAUSED=0;Micro.SPEED_SLOW=1;Micro.SPEED_MED=2;Micro.SPEED_FAST=3;Micro.ROUTE_FOUND=1;Micro.NO_ROUTE_FOUND=0;
Micro.NO_ROAD_FOUND=-1;Micro.MAX_TRAFFIC_DISTANCE=30;Micro.perimX=[-1,0,1,2,2,2,1,0,-1,-2,-2,-2];Micro.perimY=[-2,-2,-2,-1,0,1,2,2,2,1,0,-1];Micro.SPRITE_TRAIN=1;Micro.SPRITE_HELICOPTER=2;Micro.SPRITE_AIRPLANE=3;Micro.SPRITE_SHIP=4;Micro.SPRITE_MONSTER=5;Micro.SPRITE_TORNADO=6;Micro.SPRITE_EXPLOSION=7;Micro.CC_VILLAGE="VILLAGE";Micro.CC_TOWN="TOWN";Micro.CC_CITY="CITY";Micro.CC_CAPITAL="CAPITAL";Micro.CC_METROPOLIS="METROPOLIS";Micro.CC_MEGALOPOLIS="MEGALOPOLIS";Micro.CRIME=0;Micro.POLLUTION=1;
Micro.HOUSING=2;Micro.TAXES=3;Micro.TRAFFIC=4;Micro.UNEMPLOYMENT=5;Micro.FIRE=6;Micro.RES_VALVE_RANGE=2E3;Micro.COM_VALVE_RANGE=1500;Micro.IND_VALVE_RANGE=1500;Micro.taxTable=[200,150,120,100,80,50,30,0,-10,-40,-100,-150,-200,-250,-300,-350,-400,-450,-500,-550,-600];Micro.extMarketParamTable=[1.2,1.1,0.98];Micro.RLevels=[0.7,0.9,1.2];Micro.FLevels=[1.4,1.2,0.8];Micro.MAX_ROAD_EFFECT=32;Micro.MAX_POLICESTATION_EFFECT=1E3;Micro.MAX_FIRESTATION_EFFECT=1E3;Micro.COAL_POWER_STRENGTH=700;
Micro.NUCLEAR_POWER_STRENGTH=2E3;Micro.DISASTER_NONE="None";Micro.DISASTER_MONSTER="Monster";Micro.DISASTER_FIRE="Fire";Micro.DISASTER_FLOOD="Flood";Micro.DISASTER_CRASH="Crash";Micro.DISASTER_MELTDOWN="Meltdown";Micro.DISASTER_TORNADO="Tornado";Micro.CURRENT_VERSION=3;Micro.KEY="micropolisJSGame";Micro.Random=function(){};Micro.Random.prototype={constructor:Micro.Random,getChance:function(a){return 0===(this.getRandom16()&a)},getERandom:function(a){var b=this.getRandom(a);a=this.getRandom(a);return Math.min(b,a)},getRandom:function(a){return Math.floor(Math.random()*(a+1))},getRandom16:function(){return this.getRandom(65535)},getRandom16Signed:function(){var a=this.getRandom16();32768<=a&&(a=32768-a);return a}};var Random=new Micro.Random;Micro.Direction=function(){};
...
this.resPopScaled&&(this.needHospital=0);this.changed=!0},take120Census:function(){Micro.rotate120Arrays.call(this);this.resHist120[0]=Math.floor(this.resPop/8);this.comHist120[0]=this.comPop;this.indHist120[0]=this.indPop;this.crimeHist120[0]=this.crimeHist10[0];this.pollutionHist120[0]=this.pollutionHist10[0];this.moneyHist120[0]=this.moneyHist10[0];this.changed=!0}};Micro.PROBLEMS="CVP_CRIME CVP_POLLUTION CVP_HOUSING CVP_TAXES CVP_TRAFFIC CVP_UNEMPLOYMENT CVP_FIRE".split(" ");Micro.NUMPROBLEMS=Micro.PROBLEMS.length;Micro.NUM_COMPLAINTS=4;Micro.getTrafficAverage=function(a){var b=a.trafficDensityMap;a=a.landValueMap;for(var c=0,d=1,e=0;e<a.gameMapWidth;e+=a.blockSize)for(var f=0;f<a.gameMapHeight;f+=a.blockSize)0<a.worldGet(e,f)&&(c+=b.worldGet(e,f),d++);return 2.4*Math.floor(c/d)};
...
Micro.Valves.prototype={constructor:Micro.Valves,setValves:function(a,b,c){var d,e=b.resPop/8;b.totalPop=Math.round(e+b.comPop+b.indPop);var f=e+e*((0<b.resPop?(b.comHist10[1]+b.indHist10[1])/e:1)-1)+0.02*e,g=b.comHist10[1]+b.indHist10[1];d=0<g?b.resHist10[1]/g:1;d=Micro.clamp(d,0,1.3);g=(e+b.comPop+b.indPop)/3.7*d;d=b.indPop*d*Micro.extMarketParamTable[a];d=Math.max(d,5);g=0<b.comPop?g/b.comPop:g;b=0<b.indPop?d/b.indPop:d;e=Math.min(0<e?f/e:1.3,2);g=Math.min(g,2);b=Math.min(b,2);a=Math.min(c.cityTax+
...
Micro.pollutionTerrainLandValueScan=function(a,b,c){var d=c.tempMap1,e=c.tempMap2,f=c.tempMap3;f.clear();var g=c.landValueMap,h=c.terrainDensityMap,k=c.pollutionDensityMap,n=c.crimeRateMap,l,m,p,q=0,y=0;c=0;for(m=g.width;c<m;c++)for(l=0,p=g.height;l<p;l++){for(var r=0,s=!1,u=2*c,t=2*l,v=u;v<=u+1;v++)for(var x=t;x<=t+1;x++){var w=a.getTileValue(v,x);w>Tile.DIRT&&(w<Tile.RUBBLE?(w=f.worldGet(v,x),f.worldSet(v,x,w+15)):(r+=Micro.getPollutionValue(w),w>=Tile.ROADBASE&&(s=!0)))}r=Math.min(r,255);d.set(c,
l,r);s?(r=34-Math.floor(Micro.getCityCentreDistance(a,u,t)/2),r<<=2,r+=h.get(c>>1,l>>1),r-=k.get(c,l),190<n.get(c,l)&&(r-=20),r=Micro.clamp(r,1,250),g.set(c,l,r),q+=r,y++):g.set(c,l,0)}b.landValueAverage=0<y?Math.floor(q/y):0;Micro.smoothMap(d,e,Micro.SMOOTH_ALL_THEN_CLAMP);Micro.smoothMap(e,d,Micro.SMOOTH_ALL_THEN_CLAMP);c=n=g=e=0;for(m=a.width;c<m;c+=k.blockSize)for(l=0,p=a.height;l<p;l+=k.blockSize)if(q=d.worldGet(c,l),k.worldSet(c,l,q),0!==q&&(g++,n+=q,q>e||q===e&&Random.getChance(3)))e=q,a.pollutionMaxX=
c,a.pollutionMaxY=l;b.pollutionAverage=g?Math.floor(n/g):0;Micro.smoothMap(f,h,Micro.SMOOTH_NEIGHBOURS_THEN_BLOCK)};
Micro.crimeScan=function(a,b){var c=b.policeStationMap,d=b.policeStationEffectMap,e=b.crimeRateMap,f=b.landValueMap,g=b.populationDensityMap;Micro.smoothMap(c,d,Micro.SMOOTH_NEIGHBOURS_THEN_BLOCK);Micro.smoothMap(d,c,Micro.SMOOTH_NEIGHBOURS_THEN_BLOCK);Micro.smoothMap(c,d,Micro.SMOOTH_NEIGHBOURS_THEN_BLOCK);for(var h=d=0,k=0,n=e.mapWidth,l=e.blockSize;k<n;k+=l)for(var m=0,p=e.mapHeight;m<p;m+=l){var q=f.worldGet(k,m);0<q?(h+=1,q=128-q,q+=g.worldGet(k,m),q=Math.min(q,300),q-=c.worldGet(k,m),q=Micro.clamp(q,
0,250),e.worldSet(k,m,q),d+=q):e.worldSet(k,m,0)}a.crimeAverage=0<h?Math.floor(d/h):0;b.policeStationEffectMap=new Micro.BlockMap(c)};Micro.computeComRateMap=function(a,b){for(var c=b.comRateMap,d=0;d<c.width;d++)for(var e=0;e<c.height;e++){var f=Math.floor(Micro.getCityCentreDistance(a,8*d,8*e)/2),f=4*f,f=64-f;c.set(d,e,f)}};
...
Micro.populationDensityScan=function(a,b){for(var c=b.tempMap1,d=b.tempMap2,e=0,f=0,g=0,h=0,k=a.width;h<k;h++)for(var n=0,l=a.height;n<l;n++){var m=a.getTile(h,n);m.isZone()?(m=m.getValue(),m=8*Micro.getPopulationDensity(a,h,n,m),m=Math.min(m,254),c.worldSet(h,n,m),e+=h,f+=n,g++):c.worldSet(h,n,0)}Micro.smoothMap(c,d,Micro.SMOOTH_ALL_THEN_CLAMP);Micro.smoothMap(d,c,Micro.SMOOTH_ALL_THEN_CLAMP);Micro.smoothMap(c,d,Micro.SMOOTH_ALL_THEN_CLAMP);b.populationDensityMap.copyFrom(d,function(a){return 2*
a});0<g?(a.cityCentreX=Math.floor(e/g),a.cityCentreY=Math.floor(f/g)):(a.cityCentreX=Math.floor(0.5*a.width),a.cityCentreY=Math.floor(0.5*a.height))};Micro.fireAnalysis=function(a){var b=a.fireStationMap,c=a.fireStationEffectMap;Micro.smoothMap(b,c,Micro.SMOOTH_NEIGHBOURS_THEN_BLOCK);Micro.smoothMap(c,b,Micro.SMOOTH_NEIGHBOURS_THEN_BLOCK);Micro.smoothMap(b,c,Micro.SMOOTH_NEIGHBOURS_THEN_BLOCK);a.fireStationEffectMap=new Micro.BlockMap(b)};Micro.Residential=function(a){var b=function(a,b,c,d){d instanceof Micro.Tile&&(d=(new Micro.Tile).getValue());if(d===Tile.FREEZ){for(var e=0,f=b-1;f<=b+1;f++)for(var p=c-1;p<=c+1;p++)if(f!==b||p!==c)d=a.getTileValue(f,p),d>=Tile.LHTHR&&d<=Tile.HHTHR&&(e+=1);return e}return 8*(Math.floor((d-Tile.RZB)/9)%4+1)+16},c=[0,3,6,1,4,7,2,5,8],d=function(a,b,d,e,f,m,p){if(0!==f)if(16<f)Micro.putZone(a,b,d,9*(4*m+Math.floor((f-24)/8))+Tile.RZB,p),Micro.incRateOfGrowth(e,b,d,-8);else if(16===f){a.setTo(b,d,new Micro.Tile(Tile.FREEZ,
Tile.BLBNCNBIT|Tile.ZONEBIT));for(p=d-1;p<=d+1;p++)for(f=b-1;f<=b+1;f++)f===b&&p===d||a.setTo(b,d,new Micro.Tile(Tile.LHTHR+m+Random.getRandom(2),Tile.BLBNCNBIT));Micro.incRateOfGrowth(e,b,d,-8)}else for(m=0,Micro.incRateOfGrowth(e,b,d,-1),f=b-1;f<=b+1;f++)for(p=d-1;p<=d+1;p++){e=a.getTileValue(f,p);if(e>=Tile.LHTHR&&e<=Tile.HHTHR){a.setTo(f,p,new Micro.Tile(c[m]+Tile.RESBASE,Tile.BLBNCNBIT));return}m+=1}},e=function(c,e,f,n){var l;a.census.resZonePop+=1;l=c.getTileValue(e,f);var m=b(c,e,f,l);a.census.resPop+=
m;var p=c.getTile(e,f).isPowered();n=Micro.ROUTE_FOUND;if(m>Random.getRandom(35)&&(n=a.traffic.makeTraffic(e,f,a.blockMaps,Micro.isCommercial),n===Micro.NO_ROAD_FOUND)){l=Micro.getLandPollutionValue(a.blockMaps,e,f);d(c,e,f,a.blockMaps,m,l,p);return}if(l===Tile.FREEZ||Random.getChance(7)){l=a.blockMaps;if(n===Micro.NO_ROAD_FOUND)l=-3E3;else{var q=l.landValueMap.worldGet(e,f),q=q-l.pollutionDensityMap.worldGet(e,f),q=0>q?0:Math.min(32*q,6E3);l=q-3E3}l=a.valves.resValve+l;p||(l=-500);if(n&&-350<l&&
l-26380>Random.getRandom16Signed())if(0===m&&0===(Random.getRandom16()&3))0<a.census.needHospital&&(Micro.putZone(c,e,f,Tile.HOSPITAL,p),a.census.needHospital=0);else a:{if(l=Micro.getLandPollutionValue(a.blockMaps,e,f),n=a.blockMaps,!(128<n.pollutionDensityMap.worldGet(e,f))){if(c.getTileValue(e,f)===Tile.FREEZ){if(8>m){for(var p=m=0,q=[0,-1,0,1,-1,1,-1,0,1],y=[0,-1,-1,-1,0,0,1,1,1],r=0;9>r;r++){var s;s=c;var u=e+q[r],t=f+y[r],v=[0,1,0,-1],x=[-1,0,1,0],w=s.getTileValue(u,t);if(w<Tile.RESBASE||w>
Tile.RESBASE+8)s=-1;else{for(var A=1,z=0;4>z;z++)w=s.getTileValue(u+v[z],t+x[z]),w!==Tile.DIRT&&w<=Tile.LASTROAD&&(A+=1);s=A}s>p?(p=s,m=r):s===p&&Random.getChance(7)&&(m=r)}0<m&&c.setTo(e+q[m],f+y[m],new Micro.Tile(Tile.HOUSE+Random.getRandom(2)+3*l,Tile.BLBNCNBIT));Micro.incRateOfGrowth(n,e,f,1);break a}if(64<n.populationDensityMap.worldGet(e,f)){Micro.putZone(c,e,f,9*(4*l+0)+Tile.RZB,p);Micro.incRateOfGrowth(n,e,f,8);break a}}40>m&&(Micro.putZone(c,e,f,9*(4*l+(Math.floor(m/8)-1))+Tile.RZB,p),Micro.incRateOfGrowth(n,
e,f,8))}}else 350>l&&l+26380<Random.getRandom16Signed()&&(l=Micro.getLandPollutionValue(a.blockMaps,e,f),d(c,e,f,a.blockMaps,m,l,p))}},f=function(b,c,d,e){a.census.hospitalPop+=1;-1===a.census.needHospital&&0===Random.getRandom(20)&&Micro.putZone(b,c,d,Tile.FREEZ)};return{registerHandlers:function(a,b){a.addAction(Micro.isResidentialZone,e);a.addAction(Micro.HOSPITAL,f);b.addAction(Tile.HOSPITAL,15,3)},getZonePopulation:b}};Micro.Commercial=function(a){var b=function(a,b,c,d){d instanceof Micro.Tile&&(d=(new Micro.Tile).getValue());return d===Tile.COMCLR?0:Math.floor((d-Tile.CZB)/9)%5+1},c=function(a,b,c,d,k,n,l){1<k?(Micro.putZone(a,b,c,9*(5*n+(k-2))+Tile.CZB,l),Micro.incRateOfGrowth(d,b,c,-8)):1===k&&(Micro.putZone(a,b,c,Tile.COMCLR,l),Micro.incRateOfGrowth(d,b,c,-8))},d=function(d,f,g,h){var k;a.census.comZonePop+=1;h=d.getTileValue(f,g);h=b(d,f,g,h);a.census.comPop+=h;var n=d.getTile(f,g).isPowered(),l=Micro.ROUTE_FOUND;
if(h>Random.getRandom(5)&&(l=a.traffic.makeTraffic(f,g,a.blockMaps,Micro.isIndustrial),l===Micro.NO_ROAD_FOUND)){k=Micro.getLandPollutionValue(a.blockMaps,f,g);c(d,f,g,a.blockMaps,h,k,n);return}if(Random.getChance(7))if(k=l===Micro.NO_ROAD_FOUND?-3E3:a.blockMaps.comRateMap.worldGet(f,g),k=a.valves.comValve+k,n||(k=-500),l&&-350<k&&k-26380>Random.getRandom16Signed()){k=Micro.getLandPollutionValue(a.blockMaps,f,g);var l=a.blockMaps,m=l.landValueMap.worldGet(f,g);!(h>m>>5)&&5>h&&(Micro.putZone(d,f,g,
9*(5*k+h)+Tile.CZB,n),Micro.incRateOfGrowth(l,f,g,8))}else 350>k&&k+26380<Random.getRandom16Signed()&&(k=Micro.getLandPollutionValue(a.blockMaps,f,g),c(d,f,g,a.blockMaps,h,k,n))};return{registerHandlers:function(a,b){a.addAction(Micro.isCommercialZone,d)},getZonePopulation:b}};Micro.Industrial=function(a){var b=function(a,b,c,d){d instanceof Micro.Tile&&(d=(new Micro.Tile).getValue());return d===Tile.INDCLR?0:Math.floor((d-Tile.IZB)/9)%4+1},c=function(a,b,c,d,e,f,g){1<e?(Micro.putZone(a,b,c,9*(4*f+(e-2))+Tile.IZB,g),Micro.incRateOfGrowth(d,b,c,-8)):1===e&&(Micro.putZone(a,b,c,Tile.INDCLR,g),Micro.incRateOfGrowth(d,b,c,-8))},d=[!0,!1,!0,!0,!1,!1,!0,!0],e=[-1,0,1,0,0,0,0,1],f=[-1,0,-1,-1,0,0,-1,-1],g=function(g,k,n,l){a.census.indZonePop+=1;var m=g.getTileValue(k,n);l=b(g,
k,n,m);a.census.indPop+=l;var p=g.getTile(k,n).isPowered();m<Tile.IZB||(m=m-Tile.IZB>>3,d[m]&&p?g.addTileFlags(k+e[m],n+f[m],Tile.ASCBIT):(g.addTileFlags(k+e[m],n+f[m],Tile.BNCNBIT),g.removeTileFlags(k+e[m],n+f[m],Tile.ANIMBIT)));m=Micro.ROUTE_FOUND;if(l>Random.getRandom(5)&&(m=a.traffic.makeTraffic(k,n,a.blockMaps,Micro.isResidential),m===Micro.NO_ROAD_FOUND)){c(g,k,n,a.blockMaps,l,Random.getRandom16()&1,p);return}if(Random.getChance(7)){var q;q=m===Micro.NO_ROAD_FOUND?-1E3:0;q=a.valves.indValve+
q;p||(q=-500);m&&-350<q&&q-26380>Random.getRandom16Signed()?(m=a.blockMaps,q=Random.getRandom16()&1,4>l&&(Micro.putZone(g,k,n,9*(4*q+l)+Tile.IZB,p),Micro.incRateOfGrowth(m,k,n,8))):350>q&&q+26380<Random.getRandom16Signed()&&c(g,k,n,a.blockMaps,l,Random.getRandom16()&1,p)}};return{registerHandlers:function(a,b){a.addAction(Micro.isIndustrialZone,g)},getZonePopulation:b}};Micro.MiscTiles=function(a){var b=[-1,0,1,0],c=[0,-1,0,1],d=function(d,e,f,g){a.census.firePop+=1;if(0===(Random.getRandom16()&3)){for(g=0;4>g;g++)if(Random.getChance(7)&&d.testBounds(e+b[g],f+c[g])){var m=d.getTile(e,f);m.isCombustible()&&(m.isZone()&&(Micro.fireZone(d,e,f,a.blockMaps),m.getValue()>Tile.IZB&&a.spriteManager.makeExplosionAt(e,f)),d.setTo(Micro.randomFire()))}m=10;g=a.blockMaps.fireStationEffectMap.worldGet(e,f);100<g?m=1:20<g?m=2:0<g&&(m=3);0===Random.getRandom(m)&&d.setTo(e,f,Micro.randomRubble())}},
...
b;h<d;h++)if(!(0>a||a>=this._map.width||0>h||h>=this._map.height)){var k=this._map.getTile(a,h);if(k.isZone()&&!k.isPowered()&&this.shouldBlink)g.push({x:a,y:h,tileValue:Tile.LIGHTNINGBOLT});else if(k.isAnimated()){var k=k.getValue(),n=Tile.TILE_INVALID,l;this._lastPainted&&(l=this._lastPainted.getTile(a,h));f?n=l&&this.inSequence(k,l)?this._data[l]:this._data[k]:l&&this.inSequence(k,l)&&(n=l);n!==Tile.TILE_INVALID&&(g.push({x:a,y:h,tileValue:n}),e.setTile(a,h,n))}}this._lastPainted=e;return g},registerSingleAnimation:function(a){for(var b=
...
handleEvalClosed:function(){this.evalShowing=!1},handleQueryClosed:function(){this.queryShowing=!1},handleBudgetClosed:function(a,b){this.budgetShowing=!1;a||(this.simulation.budget.roadPercent=b.roadPercent/100,this.simulation.budget.firePercent=b.firePercent/100,this.simulation.budget.policePercent=b.policePercent/100,this.simulation.budget.setTax(b.taxPercent-0),this.simNeededBudget?(this.simulation.budget.doBudget(new Micro.MessageManager),this.simNeededBudget=!1):this.simulation.budget.updateFundEffects())},
