...
Micro.GameMap.prototype={constructor:Micro.GameMap,save:function(a){for(var b=0,c=Micro.GameMapProps.length;b<c;b++)a[Micro.GameMapProps[b]]=this[Micro.GameMapProps[b]];a.map=this.data.map(function(a){return{value:a.getRawValue()}});a.tileValue=[];for(b=this.fsize;b--;)a.tileValue[b]=this.tilesData[b]},load:function(a){for(var b=0,c=Micro.GameMapProps.length;b<c;b++)this[Micro.GameMapProps[b]]=a[Micro.GameMapProps[b]];for(var d=a.map,b=0,c=d.length;b<c;b++)this.setTileValue(b%this.width,Math.floor(b/
this.width),d[b].value);b=0;for(c=a.tileValue.length;b<c;b++)this.tilesData[b]=a.tileValue[b]},_calculateIndex:function(a,b){return a+b*this.width},testBounds:function(a,b){return 0<=a&&0<=b&&a<this.width&&b<this.height},getTile:function(a,b,c){"object"===typeof a&&(b=a.y,a=a.x);var d=this.width,e=this.height;if(0>a||0>b||a>=d||b>=e)return console.warn("getTile called with bad bounds",a,b),new Tile(Tile.TILE_INVALID);a=this.data[a+b*d];if(!c)return a;c.set(a);return a},getTileValue:function(a,b){var c=
Error("Invalid parameter");if(1>arguments.length)throw c;"object"===typeof a&&(b=a.y,a=a.x);if(!this.testBounds(a,b))throw c;c=this._calculateIndex(a,b);c in this.data||(this.data[c]=new Micro.Tile(this.defaultValue));return this.data[c].getValue()},getTileFlags:function(a,b){var c=Error("Invalid parameter");if(1>arguments.length)throw c;"object"===typeof a&&(b=a.y,a=a.x);if(!this.testBounds(a,b))throw c;c=this._calculateIndex(a,b);c in this.data||(this.data[c]=new Micro.Tile(this.defaultValue));
return this.data[c].getFlags()},getTiles:function(a,b,c,d){var e=Error("Invalid parameter");if(3>arguments.length)throw e;3===arguments.length&&(d=c,c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw e;for(var e=[],f=b,g=b+d;f<g;f++){e[f-b]=[];for(var h=a,k=a+c;h<k;h++){var n=this._calculateIndex(h,f);e[f-b].push(this.data[n])}}return e},getTileValues:function(a,b,c,d,e){e=e||[];var f=Error("Invalid parameter");if(3>arguments.length)throw f;3===arguments.length&&(d=c,c=b,b=a.y,a=a.x);for(var f=this.width,
g=this.height,h=b,k=b+d;h<k;h++)for(var n=a,l=a+c;n<l;n++)e[(h-b)*c+(n-a)]=0>h||0>n||h>=g||n>=f?Tile.TILE_INVALID:this.data[n+h*f].getRawValue();return e},getTileFromMapOrDefault:function(a,b,c){switch(b){case this.Direction.NORTH:return 0<a.y?this.getTileValue(a.x,a.y-1):c;case this.Direction.EAST:return a.x<this.width-1?this.getTileValue(a.x+1,a.y):c;case this.Direction.SOUTH:return a.y<this.height-1?this.getTileValue(a.x,a.y+1):c;case this.Direction.WEST:return 0<a.x?this.getTileValue(a.x-1,a.y):
c;default:return c}},setTile:function(a,b,c,d){var e=Error("Invalid parameter");if(3>arguments.length)throw e;3===arguments.length&&(d=c,c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw e;e=this._calculateIndex(a,b);this.data[e].set(c,d);this.tilesData[e]=c},setTo:function(a,b,c){var d=Error("Invalid parameter");if(2>arguments.length)throw d;void 0===c&&(c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw d;d=this._calculateIndex(a,b);this.data[d]=c;this.tilesData[d]=c.getValue()},setTileValue:function(a,
b,c){var d=Error("Invalid parameter");if(2>arguments.length)throw d;2===arguments.length&&(c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw d;d=this._calculateIndex(a,b);this.data[d].setValue(c);this.tilesData[d]=c},setTileFlags:function(a,b,c){var d=Error("Invalid parameter");if(2>arguments.length)throw d;2===arguments.length&&(c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw d;d=this._calculateIndex(a,b);this.data[d].setFlags(c)},addTileFlags:function(a,b,c){var d=Error("Invalid parameter");if(2>
arguments.length)throw d;2===arguments.length&&(c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw d;d=this._calculateIndex(a,b);this.data[d].addFlags(c)},removeTileFlags:function(a,b,c){var d=Error("Invalid parameter");if(2>arguments.length)throw d;2===arguments.length&&(c=b,b=a.y,a=a.x);if(!this.testBounds(a,b))throw d;d=this._calculateIndex(a,b);this.data[d].removeFlags(c)},putZone:function(a,b,c,d){var e=Error("Invalid parameter");if(!this.testBounds(a,b)||!this.testBounds(a-1+d,b-1+d))throw e;c=
c-1-d;for(var e=a-1,f=b-1,g=f;g<f+d;g++)for(var h=e;h<e+d;h++)h===a&&g===b?this.setTo(h,g,new Micro.Tile(c,Tile.BNCNBIT|Tile.ZONEBIT)):this.setTo(h,g,new Micro.Tile(c,Tile.BNCNBIT)),c+=1}};Micro.TERRAIN_CREATE_ISLAND=0;Micro.TERRAIN_TREE_LEVEL=-1;Micro.TERRAIN_LAKE_LEVEL=-1;Micro.TERRAIN_CURVE_LEVEL=-1;Micro.ISLAND_RADIUS=18;
...
Micro.Simulation.prototype={constructor:Micro.Simulation,save:function(a){for(var b=0,c=Micro.savePropsVar.length;b<c;b++)a[Micro.savePropsVar[b]]=this[Micro.savePropsVar[b]];this.map.save(a);this.evaluation.save(a);this.valves.save(a);this.budget.save(a);this.census.save(a)},load:function(a){console.log(a);this.messageManager.clear();for(var b=0,c=Micro.savePropsVar.length;b<c;b++)this[Micro.savePropsVar[b]]=a[Micro.savePropsVar[b]];this.evaluation.load(a);this.valves.load(a);this.budget.load(a);
this.census.load(a)},setSpeed:function(a){if(a!==Micro.SPEED_PAUSED&&a!==Micro.SPEED_SLOW&&a!==Micro.SPEED_MED&&a!==Micro.SPEED_FAST)throw Error("Invalid speed!");this.speed=a},setDifficulty:function(a){if(a!==Micro.LEVEL_EASY&&a!==Micro.LEVEL_MED&&a!==Micro.LEVEL_HARD)throw Error("Invalid level!");this.gameLevel=a;this.disasterManager.setDifficulty(this.gameLevel)},isPaused:function(){return this.speed===Micro.SPEED_PAUSED},simFrame:function(){this.budget.awaitingValues||0===this.speed||1===this.speed&&
0!==this.speedCycle%5||2===this.speed&&0!==this.speedCycle%3||(this.messageManager.clear(),this.simulate())},clearCensus:function(){this.census.clearCensus();this.powerManager.clearPowerStack();this.blockMaps.fireStationMap.clear();this.blockMaps.policeStationMap.clear()},init:function(){Residential=new Micro.Residential(this);Commercial=new Micro.Commercial(this);Industrial=new Micro.Industrial(this);Road=new Micro.Road(this);Transport=new Micro.Transport(this);EmergencyServices=new Micro.EmergencyServices(this);
