...
function(b){a.onMouseMove(b)},!1);var b=document.body;b.addEventListener?(b.addEventListener("mousewheel",function(b){a.onMouseWheel(b)},!1),b.addEventListener("DOMMouseScroll",function(b){a.onMouseWheel(b)},!1)):b.attachEvent&&b.attachEvent("onmousewheel",function(b){a.onMouseWheel(b)});this.isMobile||this.bindKeys();start();this.loadImagesPlus()},runStats:function(){this.f[1]=Date.now();this.f[1]-1E3>this.f[0]&&(this.f[0]=this.f[1],hub.upStats(this.f[2],this.renderer.info.memory.programs),this.f[2]=
0);this.f[2]++},render:function(){this.isWithStats&&this.runStats();this.renderer.render(this.scene,this.camera);this.deepthTest&&this.miniRender()},initMiniRender:function(){this.minibuilding=this.miniTree=null;this.miniTreeUpdate=0;this.townHeigth=this.customShader();this.miniScene=new THREE.Scene;this.topCamera=new THREE.OrthographicCamera(-5,5,5,-5,0.1,200);this.topCameraDistance=10;this.miniScene.add(this.topCamera);this.miniRenderer=new THREE.WebGLRenderer({canvas:miniGlCanvas,precision:"lowp",
antialias:!1});this.miniRenderer.setSize(this.miniSize.w,this.miniSize.h,!0);this.miniRenderer.sortObjects=!1;this.miniRenderer.sortElements=!1;this.deepthTest=!0},customShader:function(){return new THREE.ShaderMaterial({uniforms:{deep:{type:"f",value:0.1}},attributes:{},vertexShader:"uniform float deep;\nvarying float dy;\nvarying vec4 vc;\nvoid main(void) {\ngl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);\ndy = position.y*deep;\nvc = vec4(dy,dy,dy, 1.0);\n}",fragmentShader:"precision lowp float;\nvarying vec4 vc;\nvoid main(void) { gl_FragColor = vc; }"})},
miniClear:function(){for(var a=this.miniScene.children.length,b;a--;)b=this.miniScene.children[a],b.geometry&&(b.geometry.dispose(),this.miniScene.remove(b))},miniClearMesh:function(a){a.geometry.dispose();this.miniScene.remove(a)},miniCheck:function(){var a=this.findLayer(this.center.x,this.center.z);a!==this.currentLayer?(this.currentLayer=a,this.miniUpTree(a),this.miniUpBuilding(a)):1==this.miniTreeUpdate&&(this.miniUpTree(a),this.miniTreeUpdate=0)},miniUpTree:function(a){null!==this.miniTree&&
this.miniClearMesh(this.miniTree);this.miniTree=new THREE.Mesh(this.treeMeshs[a].geometry.clone(),this.townHeigth);this.miniScene.add(this.miniTree)},miniUpBuilding:function(a){this.buildingMeshs[a]&&(null!==this.minibuilding&&this.miniClearMesh(this.minibuilding),this.minibuilding=new THREE.Mesh(this.buildingMeshs[a].geometry.clone(),this.townHeigth),this.miniScene.add(this.minibuilding))},miniRender:function(){this.deepthTest&&(this.miniCheck(),this.miniRenderer.render(this.miniScene,this.topCamera))},
...
1===a.num&&null!==hub&&(hub.subtitle.innerHTML="Loading textures ...");a.num===a.imgSrc.length?(a.changeTextures(),a.num=0):a.loadImages()};this.imgs[b].src=this.imgSrc[b]},loadImagesPlus:function(){var a=this,b=this.num+5;this.imgs[b]=new Image;this.imgs[b].src=this.imgSrcPlus[this.num];this.imgs[b].onload=function(){a.num++;a.num===a.imgSrcPlus.length?a.winterMapLoaded=!0:a.loadImagesPlus()}},winterSwitch:function(){this.isWinter=!this.isWinter&&this.winterMapLoaded?!0:!1;this.updateBackground();
this.setTimeColors(this.dayTime)},changeTextures:function(){this.groundCanvas=document.createElement("canvas");this.townCanvas=document.createElement("canvas");this.buildingCanvas=document.createElement("canvas");this.groundCanvas.width=this.groundCanvas.height=this.imgs[0].width;this.townCanvas.width=this.townCanvas.height=this.imgs[1].width;this.buildingCanvas.width=this.buildingCanvas.height=this.imgs[2].width;this.tint(this.groundCanvas,this.imgs[0]);this.tint(this.townCanvas,this.imgs[1],this.imgs[4]);
this.tint(this.buildingCanvas,this.imgs[2],this.imgs[3]);this.imageSrc=this.groundCanvas;this.createTextures()},createTextures:function(){this.isWithEnv&&(this.environment=THREE.ImageUtils.loadTexture("img/env.jpg",THREE.SphericalReflectionMapping),this.environment2=THREE.ImageUtils.loadTexture("img/env.jpg",THREE.SphericalReflectionMapping));this.townTexture=new THREE.Texture(this.townCanvas);this.townTexture.flipY=!1;this.townTexture.magFilter=THREE.NearestFilter;this.townTexture.minFilter=THREE.LinearMipMapLinearFilter;
this.townTexture.needsUpdate=!0;this.buildingTexture=new THREE.Texture(this.buildingCanvas);this.buildingTexture.flipY=!1;this.buildingTexture.magFilter=THREE.NearestFilter;this.buildingTexture.minFilter=THREE.LinearMipMapLinearFilter;this.buildingTexture.needsUpdate=!0;this.townMaterial=new THREE.MeshBasicMaterial({map:this.townTexture});this.buildingMaterial=new THREE.MeshBasicMaterial({map:this.buildingTexture});this.isWithEnv&&(this.townMaterial.envMap=this.environment,this.buildingMaterial.envMap=
this.environment);this.loadSea3d()},textureSwitch:function(a){switch(a){case "normal":this.townMaterial.map=this.townTexture,this.buildingMaterial.map=this.buildingTexture}},setTimeColors:function(a){this.dayTime=a;1==this.dayTime&&(this.tcolor={r:100,g:15,b:80,a:0.3});2==this.dayTime&&(this.tcolor={r:10,g:15,b:80,a:0.8});3==this.dayTime&&(this.tcolor={r:10,g:15,b:80,a:0.6});this.tint(this.skyCanvas);this.isWinter?(this.tint(this.groundCanvas,this.imgs[5]),this.tint(this.townCanvas,this.imgs[6],this.imgs[4]),
this.tint(this.buildingCanvas,this.imgs[7],this.imgs[3])):(this.tint(this.groundCanvas,this.imgs[0]),this.tint(this.townCanvas,this.imgs[1],this.imgs[4]),this.tint(this.buildingCanvas,this.imgs[2],this.imgs[3]));this.isWithFog&&(this.isIsland?this.isWinter?(0==this.dayTime&&this.fog.color.setHex(11529966),1==this.dayTime&&this.fog.color.setHex(10005439),2==this.dayTime&&this.fog.color.setHex(2833520),3==this.dayTime&&this.fog.color.setHex(5007503)):(0==this.dayTime&&this.fog.color.setHex(6711014),
1==this.dayTime&&this.fog.color.setHex(6638777),2==this.dayTime&&this.fog.color.setHex(1843310),3==this.dayTime&&this.fog.color.setHex(3093132)):this.isWinter?(0==this.dayTime&&this.fog.color.setHex(15134975),1==this.dayTime&&this.fog.color.setHex(12561610),2==this.dayTime&&this.fog.color.setHex(3554419),3==this.dayTime&&this.fog.color.setHex(6449558)):(0==this.dayTime&&this.fog.color.setHex(14849133),1==this.dayTime&&this.fog.color.setHex(12348516),2==this.dayTime&&this.fog.color.setHex(3484246),
3==this.dayTime&&this.fog.color.setHex(6308956)));this.buildingTexture.needsUpdate=!0;this.townTexture.needsUpdate=!0;this.fullRedraw=this.skyTexture.needsUpdate=!0},loadSea3d:function(){var a=this,b=new THREE.SEA3D(!0);new THREE.MeshBasicMaterial({color:0});b.onComplete=function(c){for(var e=b.meshes.length;e--;)c=b.meshes[e],c.material.dispose(),a.meshs[c.name]=c;a.defineGeometry()};b.parser=this.seaBuffer?THREE.SEA3D.BUFFER:THREE.SEA3D.DEFAULT;b.load(this.rootModel);null!==hub&&(hub.subtitle.innerHTML=
"Loading 3d model ...")},defineGeometry:function(){var a,b=(new THREE.Matrix4).makeScale(1,1,-1);new THREE.Matrix4;this.buildingGeo=[];this.buildingGeo[0]=null;this.buildingGeo[1]=null;this.buildingGeo[2]=null;this.buildingGeo[3]=null;this.buildingGeo[4]=this.meshs.police.geometry;this.buildingGeo[5]=this.meshs.park_1.geometry;this.buildingGeo[6]=this.meshs.park_2.geometry;this.buildingGeo[7]=this.meshs.fire.geometry;this.buildingGeo[8]=this.meshs.coal.geometry;this.buildingGeo[9]=this.meshs.nuclear.geometry;
this.buildingGeo[10]=this.meshs.port.geometry;this.buildingGeo[11]=this.meshs.stadium.geometry;this.buildingGeo[12]=this.meshs.airport.geometry;this.residentialGeo=[];this.commercialGeo=[];this.industrialGeo=[];this.houseGeo=[];for(a=9;a--;)this.industrialGeo[a]=this.meshs["i_0"+a].geometry,this.industrialGeo[a].applyMatrix(b);for(a=19;a--;)this.residentialGeo[a]=10>a?this.meshs["r_0"+a].geometry:this.meshs["r_"+a].geometry,this.residentialGeo[a].applyMatrix(b);for(a=21;a--;)this.commercialGeo[a]=
10>a?this.meshs["c_0"+a].geometry:this.meshs["c_"+a].geometry,this.commercialGeo[a].applyMatrix(b);for(a=12;a--;)this.houseGeo[a]=10>a?this.meshs["rh_0"+a].geometry:this.meshs["rh_"+a].geometry,this.houseGeo[a].applyMatrix(b);for(a=this.buildingGeo.length;a--;)null!==this.buildingGeo[a]&&this.buildingGeo[a].applyMatrix(b);this.spriteGeo=[];this.spriteGeo[0]=this.meshs.train.geometry;this.spriteGeo[1]=this.meshs.elico.geometry.clone();this.spriteGeo[2]=this.meshs.plane.geometry;for(a=this.spriteGeo.length;a--;)this.spriteGeo[a].applyMatrix(b);
this.treeGeo=[];this.treeGeo[0]=this.meshs.ttt3.geometry;this.treeGeo[1]=this.meshs.ttt3.geometry.clone();this.treeGeo[2]=this.meshs.ttt4.geometry;this.treeGeo[3]=this.meshs.ttt4.geometry.clone();this.treeGeo[4]=this.meshs.ttt0.geometry;this.treeGeo[5]=this.meshs.ttt1.geometry;this.treeGeo[6]=this.meshs.ttt2.geometry;this.treeGeo[7]=this.meshs.ttt5.geometry;for(a=this.treeGeo.length;a--;)this.treeGeo[a].applyMatrix(b);this.init()},getRandomObject:function(){var a,b;switch(this.randRange(0,6)){case 0:a=
this.buildingGeo[this.randRange(4,12)];b=this.townMaterial;break;case 1:a=this.residentialGeo[this.randRange(1,this.residentialGeo.length-1)];b=this.buildingMaterial;break;case 2:a=this.commercialGeo[this.randRange(1,this.commercialGeo.length-1)];b=this.buildingMaterial;break;case 3:a=this.industrialGeo[this.randRange(1,this.industrialGeo.length-1)];b=this.buildingMaterial;break;case 4:a=this.houseGeo[this.randRange(0,this.houseGeo.length-1)];b=this.buildingMaterial;break;case 5:a=this.spriteGeo[this.randRange(0,
this.spriteGeo.length-1)];b=this.townMaterial;break;case 6:a=this.randRange(0,2),b=0,1==a&&(b=4),2==a&&(b=6),a=this.treeGeo[b],b=this.townMaterial}b=new THREE.Mesh(a.clone(),b.clone());b.name=a.name;return b},randRange:function(a,b){return Math.floor(Math.random()*(b-a+1))+a},transGeo:function(a){this.isTransGeo&&(a.mergeVertices(),a.computeVertexNormals(!0),a.computeTangents(),a.verticesNeedUpdate=!0);return a},addTree:function(a,b,c,e,f){this.isWithTree&&(this.treeLists[f]||(this.treeLists[f]=[]),
this.treeLists[f].push([a,b,c,e]))},populateTree:function(){if(this.isWithTree)for(var a=new THREE.Matrix4,b,c=this.nlayers;c--;)if(this.treeLists[c]){for(var e=this.treeLists[c].length,f=new THREE.Geometry;e--;)b=this.treeLists[c][e],a.makeTranslation(b[0],b[1],b[2]),f.merge(this.treeGeo[b[3]],a);this.isBuffer?(f=this.transGeo(f),b=(new THREE.BufferGeometry).fromGeometry(f),f.dispose(),this.treeMeshs[c]=new THREE.Mesh(b,this.townMaterial)):this.treeMeshs[c]=new THREE.Mesh(f,this.townMaterial);this.scene.add(this.treeMeshs[c]);
this.tempTreeLayers[c]=0}},clearAllTrees:function(){if(this.isWithTree){for(var a=this.nlayers;a--;)this.treeMeshs[a]&&(this.scene.remove(this.treeMeshs[a]),this.treeMeshs[a].geometry&&this.treeMeshs[a].geometry.dispose());this.treeMeshs=[];this.treeLists=[];this.tempTreeLayers=[]}},removeTreePack:function(a){if(this.isWithTree){for(var b=a.length;b--;)this.removeTree(a[b][0],a[b][1],!0);for(b=this.tempTreeLayers.length;b--;)1===this.tempTreeLayers[b]&&this.rebuildTreeLayer(b)}},removeTree:function(a,
b,c){var e=this.findLayer(a,b),f;if(this.treeLists[e])for(var h=this.treeLists[e].length;h--;)if(f=this.treeLists[e][h],f[0]==a&&f[2]==b)if(this.treeLists[e].splice(h,1),c)this.tempTreeLayers[e]=1;else{this.rebuildTreeLayer(e);break}},rebuildTreeLayer:function(a){if(this.isWithTree){this.scene.remove(this.treeMeshs[a]);this.treeMeshs[a].geometry.dispose();for(var b=new THREE.Matrix4,c,e=this.treeLists[a].length,f=new THREE.Geometry;e--;)c=this.treeLists[a][e],b.makeTranslation(c[0],c[1],c[2]),f.merge(this.treeGeo[c[3]],
b);this.isBuffer?(f=this.transGeo(f),b=(new THREE.BufferGeometry).fromGeometry(f),f.dispose(),this.treeMeshs[a]=new THREE.Mesh(b,this.townMaterial)):this.treeMeshs[a]=new THREE.Mesh(f,this.townMaterial);this.scene.add(this.treeMeshs[a]);this.tempTreeLayers[a]=0;a==this.currentLayer&&(this.miniTreeUpdate=1)}},updateBackground:function(){var a;this.isWithBackground?(this.isIsland?(a="#6666e6",this.isWinter&&(a="#AFEEEE"),this.skyCanvasBasic=this.gradTexture([[0.51,0.49,0.3],[a,"#BFDDFF","#4A65FF"]]),
this.skyCanvas=this.gradTexture([[0.51,0.49,0.3],[a,"#BFDDFF","#4A65FF"]]),this.isWithFog&&(this.isWinter?this.fog.color.setHex(11529966):this.fog.color.setHex(6711014))):(a="#E2946D",this.isWinter&&(a="#E6F0FF"),this.skyCanvasBasic=this.gradTexture([[0.51,0.49,0.3],[a,"#BFDDFF","#4A65FF"]]),this.skyCanvas=this.gradTexture([[0.51,0.49,0.3],[a,"#BFDDFF","#4A65FF"]]),this.isWithFog&&(this.isWinter?this.fog.color.setHex(15134975):this.fog.color.setHex(14849133))),this.skyTexture=new THREE.Texture(this.skyCanvas),
this.skyTexture.needsUpdate=!0,this.back.material.map=this.skyTexture):this.isIsland?this.renderer.setClearColor(6711014,1):this.renderer.setClearColor(13401958,1)},updateTerrain:function(a){this.isIsland=a||!1;this.center.x=0.5*this.mapSize[0];this.center.z=0.5*this.mapSize[1];this.updateBackground();if(0===this.miniTerrain.length){a=0;for(var b=[0,2228224,4456448,6684672,8912896,11141120,13369344,16711680],c=[0,8704,17408,26112,34816,43520,52224,65280],e=0;8>e;e++)for(var f=0;8>f;f++){var h;h=this.isWithHeight?
new THREE.PlaneGeometry(16,16,16,16):new THREE.PlaneBufferGeometry(16,16,1,1);h.applyMatrix((new THREE.Matrix4).makeRotationX(0.5*-Math.PI));this.miniTerrain[a]=this.isColorTest?new THREE.Mesh(h,new THREE.MeshBasicMaterial({color:b[e]+c[f]})):new THREE.Mesh(h,new THREE.MeshBasicMaterial({color:16777215}));this.isWithEnv&&(this.miniTerrain[a].material.envMap=this.environment2);this.miniTerrain[a].position.set(8+16*f-0.5,0,8+16*e-0.5);this.land.add(this.miniTerrain[a]);a++}}for(a=this.miniTerrain.length;a--;)b=
new THREE.Texture(this.miniCanvas[a]),b.magFilter=THREE.NearestFilter,b.minFilter=THREE.LinearMipMapLinearFilter,b.needsUpdate=!0,this.miniTerrain[a].material.map=b,this.terrainTxt[a]=b;this.isWithHeight?(this.applyHeight(),this.center.y=this.heightData[this.findId(this.center.x,this.center.z)]):this.center.y=0;this.moveCamera();this.back.position.copy(this.center)},generateHeight:function(){if(0!=this.miniTerrain.length){for(var a=this.miniTerrain.length;a--;)this.land.remove(this.miniTerrain[a]);
this.miniTerrain=[]}for(var b=this.mapSize[0],c=b*this.mapSize[1],a=new ARRAY_TYPE(c),e=new ImprovedNoise,f=1,h=100*Math.random(),g=0;4>g;g++){for(var k=0;k<c;k++){var l=k%b,m=~~(k/b);a[k]+=Math.abs(e.noise(l/f,m/f,h)*f*0.2)}f*=5}for(b=a.length;b--;){m=this.findPosition(b);l=m[0];m=m[1];e=c=0;if(16==m||32==m||48==m||64==m||80==m||96==m||112==m)e=1;if(16==l||32==l||48==l||64==l||80==l||96==l||112==l)c=1;c&&(a[b]=a[b-1]);e&&(a[b]=a[b-128]);c&&e&&(a[b]=a[b-129])}return a},resetHeight:function(){for(var a=
this.heightData.length;a--;)this.heightData[a]=0;this.applyHeight();this.isWithHeight=!1},applyHeight:function(){for(var a=this.heightData.length,b,c;a--;)b=this.findPosition(a),c=this.findLayer(b[0],b[1]),b=this.findVertices(c,b),this.moveFaces(this.miniTerrain[c],b,this.heightData[a]);for(a=this.miniTerrain.length;a--;)this.miniTerrain[a].geometry.computeFaceNormals(),this.isComputeVertex&&this.miniTerrain[a].geometry.computeVertexNormals(),this.miniTerrain[a].geometry.verticesNeedUpdate=!0},makePlanar:function(a,
b){for(var c,e,f,h=a.length;h--;)e=a[h][0],f=a[h][1],c=this.findLayer(e,f),e=this.findVertices(c,[e,f]),this.moveFaces(this.miniTerrain[c],e,b),this.tempHeightLayers[c]=1;for(h=this.tempHeightLayers.length;h--;)1===this.tempHeightLayers[h]&&(this.miniTerrain[h].geometry.computeFaceNormals(),this.isComputeVertex&&this.miniTerrain[h].geometry.computeVertexNormals(),this.miniTerrain[h].geometry.verticesNeedUpdate=!0);this.tempHeightLayers=[]},moveFaces:function(a,b,c){var e=a.geometry.faces[2*b];b=a.geometry.faces[2*
b+1];a=a.geometry.vertices;a[e.a].y=a[e.b].y=a[e.c].y=c;a[b.a].y=a[b.b].y=a[b.c].y=c},findLayer:function(a,b){return Math.floor(a/16)+8*Math.floor(b/16)},findLayerPos:function(a,b,c){var e=Math.floor(c/8);return[a-16*Math.floor(c-8*e),b-16*e]},findPosition:function(a){var b=Math.floor(a/this.mapSize[1]);return[a-b*this.mapSize[1],b]},findId:function(a,b){return a+b*this.mapSize[1]},findVertices:function(a,b){var c=0,c=Math.floor(a/8);return c=b[0]-16*Math.floor(a-8*c)+16*(b[1]-16*c)},rayTest:function(){this.rayVector.unproject(this.camera);
this.raycaster.ray.set(this.camera.position,this.rayVector.sub(this.camera.position).normalize());if(0<this.land.children.length){var a=this.raycaster.intersectObjects(this.land.children);0<a.length?(this.pos.x=Math.round(a[0].point.x),this.pos.z=Math.round(a[0].point.z),this.pos.y=this.isWithHeight?Math.round(a[0].point.y):0,this.currentTool&&(this.tool.position.set(this.pos.x,this.pos.y,this.pos.z),(this.mouse.click||this.mouse.drag)&&mapClick(),this.mouse.click=!1)):(this.pos.x=-1,this.pos.z=-1)}},
selectTool:function(a){this.pos.x=-1;this.pos.z=-1;null!==this.tool&&this.removeTool();0===a||18===a?(this.currentTool=null,this.mouse.dragView=!1,this.mouse.move=!0):16===a?(this.currentTool=null,this.mouse.move=!1,this.mouse.dragView=!0):(this.currentTool=this.toolSet[a],this.mouse.move=!1,this.mouse.dragView=!1,this.tool=this.customTool(),this.scene.add(this.tool));sendTool(this.toolSet[a].tool)},customTool:function(){var a=this.currentTool.size,b=this.currentTool.color,c=0.5*a,e=0;4==a?e=0.5:
6==a&&(e=1.5);a=new THREE.Geometry;c=[new THREE.Vector3(-c+e,0.02,-c+e),new THREE.Vector3(-c+e,0.02,c+e),new THREE.Vector3(c+e,0.02,c+e),new THREE.Vector3(c+e,0.02,-c+e)];a.vertices.push(c[0],c[1],c[1],c[2],c[2],c[3],c[3],c[0]);b=new THREE.Line(a,new THREE.LineBasicMaterial({color:b,linewidth:3}),THREE.LinePieces);b.overdraw=!0;return b},build:function(a,b){if("query"!==this.currentTool.tool)if(this.currentTool.build){var c=this.currentTool.size,e=0;this.isWithHeight&&(e=this.heightData[this.findId(a,
b)]);var f;1==c?f=[[a,b]]:3==c?f=[[a,b],[a-1,b],[a+1,b],[a,b-1],[a-1,b-1],[a+1,b-1],[a,b+1],[a-1,b+1],[a+1,b+1]]:4==c?f=[[a,b],[a-1,b],[a+1,b],[a,b-1],[a-1,b-1],[a+1,b-1],[a,b+1],[a-1,b+1],[a+1,b+1],[a+2,b-1],[a+2,b],[a+2,b+1],[a+2,b+2],[a-1,b+2],[a,b+2],[a+1,b+2]]:6==c&&(f=[[a,b],[a-1,b],[a+1,b],[a,b-1],[a-1,b-1],[a+1,b-1],[a,b+1],[a-1,b+1],[a+1,b+1],[a+2,b-1],[a+2,b],[a+2,b+1],[a+2,b+2],[a-1,b+2],[a,b+2],[a+1,b+2],[a+3,b-1],[a+4,b-1],[a+3,b],[a+4,b],[a+3,b+1],[a+4,b+1],[a+3,b+2],[a+4,b+2],[a+3,
...
a+"<br>";g.id=a;for(var k=[],l=0;l!==b.length;l++)k[l]=document.createElement("div"),k[l].style.cssText="font-size:14px; border:1px solid "+this.colors[5]+"; background:"+this.colors[1]+"; color:"+this.colors[0]+";",k[l].style.cssText="Speed"==a?k[l].style.cssText+" width:70px; height:16px; margin-left:2px; padding:6px; pointer-events:auto;  cursor:pointer; display:inline-block; ":k[l].style.cssText+" width:70px; height:16px; margin:2px; padding:7px; pointer-events:auto;  cursor:pointer; display:inline-block; ",
