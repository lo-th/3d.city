...
Micro.GameMap.prototype = {
    ...
    getTile : function(x, y) {
        ...
        if (!(tileIndex in this._data)) this._data[tileIndex] = new Micro.Tile(this.defaultValue);
    ...
    getTileValue : function(x, y) {
        ...
        if (!(tileIndex in this._data))
          this._data[tileIndex] = new Micro.Tile(this.defaultValue);
        ...
        for (var y = startY; y < startY + size; y++) {
          for (var x = startX; x < startX + size; x++) {
            if (x === centreX && y === centreY)
              this.setTo(x, y, new Micro.Tile(tile, Tile.BNCNBIT | Tile.ZONEBIT));
            else
              this.setTo(x, y, new Micro.Tile(tile, Tile.BNCNBIT));
            tile += 1;
          }
        } 
    }
