...
export class Hub_Save_Load extends Hub_Pannel {
	...
	init() {
        ...
        var bg3 = this.hubMain.addButton(this.body, 'SAVE', [138, 26, 11], null);
        var bg4 = this.hubMain.addButton(this.body, 'LOAD', [138, 26, 11], null);
        ...
        var bg2 = this.hubMain.addButton(this.body, 'NEW MAP',  [138, 26, 11], null);
